...
class ClientArenaComponentSystem(ComponentSystem):
    ...
    def __onSyncObjectUpdateReceived(self, argStr):
        ...
        return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client_common\arena_component_system\client_arena_component_system.pyc 
