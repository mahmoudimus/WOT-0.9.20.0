...
class ArenaSyncObject(object):
    ...
    def __processDiffPath(self, diffpath, changeList):
        ...
        if diffpath not in diff_ptr:
            ...
            return (True, diff_ptr[diffpath])
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client_common\arena_component_system\arena_sync_object.pyc 
