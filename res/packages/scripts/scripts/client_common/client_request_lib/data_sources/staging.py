# 2017.08.29 21:52:18 Støední Evropa (letní èas)
...
class StagingDataAccessor(base.BaseDataAccessor):
    ...
    def get_strongholds_state(self, callback, clan_id, fields = None):
        ...
        return self._request_data(inner_callback, 'strongholds', url)
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client_common\client_request_lib\data_sources\staging.pyc 
