# 2017.08.29 21:52:17 Støední Evropa (letní èas)
...
def fetchURL(url, callback, headers = {}, timeout = 30, method = 'GET', postData = ''):
    ...
    *            the data is encoded in the right format(i.e. JSON/XML).
    ...
    return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client_common\client_request_lib\data_sources\fetcher.pyc 
