# 2017.08.29 21:42:53 Støední Evropa (letní èas)
...
class ClientSelectableObject(BigWorld.Entity):
    ...
    def onClicked(self):
        if self.__clickSound is None:
            ...
            self.__clickSound.play()
        return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\ClientSelectableObject.pyc 
