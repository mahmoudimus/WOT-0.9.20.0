# 2017.08.29 21:44:00 Støední Evropa (letní èas)
...
class ComponentDragManager:
    ...
    def handleMouseEvent(self, event):
        if self.component is None:
            ...
            dragged = draggedHorz or draggedVert
            if dragged and hasattr(self.component.script, 'onDragging'):
                self.component.script.onDragging()
            return True
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\bwobsolete_helpers\PyGUI\DraggableComponent.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:44:01 Støední Evropa (letní èas)
