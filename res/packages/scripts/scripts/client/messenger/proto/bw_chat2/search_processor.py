# 2017.08.29 21:51:12 Støední Evropa (letní èas)
...
class SearchUsersProcessor(SearchProcessor):
    ...
    def __um_onSearchTokenFailed(self, requestID, args):
        if self._lastRequestID == requestID:
            ...
            self._onSearchFailed(reason)
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\messenger\proto\bw_chat2\search_processor.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:51:13 Støední Evropa (letní èas)
