...
class IUserSearchLimits(object):
    ...
    def getRequestCooldown(self):
        raise NotImplementedError
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\messenger\proto\interfaces.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:51:06 Støední Evropa (letní èas)
