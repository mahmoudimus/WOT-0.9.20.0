# 2017.08.29 21:51:21 Støední Evropa (letní èas)
...
class ChangeRosterItemsGroupsChain(ChangeRosterItemGroupsTask, _RosterItemsGroupsChain):
    ...
    def clone(self):
        if self._chain:
            ...
            tasks = []
        return tasks
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\messenger\proto\xmpp\contacts\roster_tasks.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:51:22 Støední Evropa (letní èas)
