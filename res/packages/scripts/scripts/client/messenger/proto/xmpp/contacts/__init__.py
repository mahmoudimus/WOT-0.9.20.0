# 2017.08.29 21:51:23 Støední Evropa (letní èas)
...
from messenger.proto.shared_find_criteria import ProtoFindCriteria, TemporaryIgnoredFindCriteria
...
class ContactsManager(ClientEventsHandler):
    ...
    def __onSeqsInited(self):
        ...
        self.__subsBatch.process(self.__tasks)
        self.__subsRestrictions.setToUseCachedCounts(False)
        g_messengerEvents.users.onUsersListReceived({USER_TAG.FRIEND,
         USER_TAG.IGNORED,
    ...
    def __ms_onUserPreferencesUpdated(self):
        self.__seq.release()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\messenger\proto\xmpp\contacts\__init__.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:51:24 Støední Evropa (letní èas)
