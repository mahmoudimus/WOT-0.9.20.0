# 2017.08.29 21:51:28 Støední Evropa (letní èas)
...
class _RoomAction(ClientHolder):
    ...
    def start(self):
        raise self._room is not None or AssertionError('Room must be defined')
        raise self._step == ENTRY_STEP.UNDEFINED or AssertionError
        self._doStart()
        return
...
class MUCProvider(ChatProvider):
    ...
    def __filterActions(self):
        ...
        return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\messenger\proto\xmpp\messages\muc.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:51:29 Støední Evropa (letní èas)
