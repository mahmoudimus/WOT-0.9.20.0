...
class ContactCreateNoteView(ContactManageNoteView):
    ...
    def _getInitDataObject(self):
        ...
        self._extendInitData(defData)
        return defData
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\messenger\gui\Scaleform\view\lobby\contact_manage_note_views.pyc 
