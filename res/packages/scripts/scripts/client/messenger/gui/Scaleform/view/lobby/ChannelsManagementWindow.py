...
class ChannelsManagementWindow(ChannelsManagementWindowMeta, ISearchHandler):
    ...
    def _dispose(self):
        ...
        return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\messenger\gui\Scaleform\view\lobby\ChannelsManagementWindow.pyc 
