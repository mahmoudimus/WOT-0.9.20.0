...
class TrainingChannelController(LobbyChannelController, ILegacyListener):
    ...
    def _buildMembersList(self):
        ...
        self._refreshMembersDP()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\messenger\gui\Scaleform\channels\bw_chat2\lobby_controllers.pyc 
