# 2017.08.29 21:50:57 Støední Evropa (letní èas)
...
class ContactsDataProvider(DAAPIDataProvider):
    ...
    def __me_onNotesListReceived(self):
        self.buildList()
        self.refresh()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\messenger\gui\Scaleform\data\contacts_data_provider.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:50:58 Støední Evropa (letní èas)
