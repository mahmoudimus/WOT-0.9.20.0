# 2017.08.29 21:43:39 Støední Evropa (letní èas)
...
class ArcadeCamera(ICamera, CallbackDelayer, TimeDeltaMeter):
    ...
    def __onRecreateDevice(self):
        self.__aimingSystem.aimMatrix = self.__calcAimMatrix()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\AvatarInputHandler\DynamicCameras\ArcadeCamera.pyc 
