...
class SniperAimingSystem(IAimingSystem):
    ...
    def __calcPitchExcess(self, turretYaw, gunPitch):
        ...
        elif self.__pitchCompensating + pitchLimits[1] < gunPitch:
            return self.__pitchCompensating + pitchLimits[1] - gunPitch
        else:
            return 0.0
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\AvatarInputHandler\AimingSystems\SniperAimingSystem.pyc 
