# 2017.08.29 21:43:33 Støední Evropa (letní èas)
...
class RemoteCameraSender(InputHandlerCommand):
    ...
    def __onCameraChanged(self, cameraName, currentVehicleId = None):
        ...
        if player.isObserver():
            ...
            return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\AvatarInputHandler\remote_camera_sender.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:43:34 Støední Evropa (letní èas)
