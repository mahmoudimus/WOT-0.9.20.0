...
class _GunMarkerController(IGunMarkerController):
    ...
    def update(self, markerType, position, dir, size, relaxTime, collData):
        raise self._gunMarkerType == markerType or AssertionError
...
class _SPGGunMarkerController(_GunMarkerController):
    ...
    def enable(self):
        ...
        player = BigWorld.player()
        raise player is not None or AssertionError
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\AvatarInputHandler\gun_marker_ctrl.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:43:32 Støední Evropa (letní èas)
