# 2017.08.29 21:43:35 Støední Evropa (letní èas)
...
class AvatarInputHandler(CallbackDelayer, ComponentSystem):
    ...
    def handleKeyEvent(self, event):
        ...
        if key == Keys.KEY_SPACE and isDown and BigWorld.player().isObserver():
            ...
            return True
        elif not self.isObserverFPV and self.__curCtrl.handleKeyEvent(isDown, key, mods, event):
            return True
        else:
            return BigWorld.player().handleKey(isDown, key, mods)
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\AvatarInputHandler\__init__.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:43:36 Støední Evropa (letní èas)
