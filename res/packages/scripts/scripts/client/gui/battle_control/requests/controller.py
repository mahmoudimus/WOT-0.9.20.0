# 2017.08.29 21:44:39 Støední Evropa (letní èas)
...
class AvatarRequestsController(RequestsController):
    ...
    def _getRequestTimeOut(self):
        return 30.0
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\battle_control\requests\controller.pyc 
