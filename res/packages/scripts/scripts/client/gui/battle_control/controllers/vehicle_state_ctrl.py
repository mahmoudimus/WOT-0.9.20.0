# 2017.08.29 21:44:36 Støední Evropa (letní èas)
...
from gui.battle_control.battle_constants import VEHICLE_VIEW_STATE, VEHICLE_WAINING_INTERVAL, VEHICLE_UPDATE_INTERVAL, BATTLE_CTRL_ID
...
def createCtrl(setup):
    ...
    return ctrl
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\battle_control\controllers\vehicle_state_ctrl.pyc 
