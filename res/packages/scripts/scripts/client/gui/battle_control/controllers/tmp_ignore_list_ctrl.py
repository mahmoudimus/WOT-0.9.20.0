# 2017.08.29 21:44:35 Støední Evropa (letní èas)
...
def createTmpIgnoreListCtrl(setup):
    ...
    if arenaGuiTypeVisitor.isTutorialBattle():
        ...
        return _TmpIgnoreListCtrl(setup)
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\battle_control\controllers\tmp_ignore_list_ctrl.pyc 
