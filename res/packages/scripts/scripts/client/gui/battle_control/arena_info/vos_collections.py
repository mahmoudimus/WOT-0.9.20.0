# 2017.08.29 21:44:28 Støední Evropa (letní èas)
...
class _WinPointsSortKey(SortKey):
    ...
    def __init__(self, item, *args):
        ...
        raise len(item) > 2 or AssertionError('Given key is used in the FalloutMultiTeamItemsCollection only')
...
class FalloutMultiTeamItemsCollection(VehiclesItemsCollection):
    ...
    def _sortIfNeed(self, seq):
        ...
        return seq
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\battle_control\arena_info\vos_collections.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:44:29 Støední Evropa (letní èas)
