# 2017.08.29 21:44:27 Støední Evropa (letní èas)
...
class PlayerFullNameFormatter(object):
    ...
    def _normalizePlayerName(name):
        return name
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\battle_control\arena_info\player_format.pyc 
