# 2017.08.29 21:44:22 Støední Evropa (letní èas)
...
class FEEDBACK_EVENT_ID(object):
    PLAYER_KILLED_ENEMY, PLAYER_DAMAGED_HP_ENEMY, PLAYER_DAMAGED_DEVICE_ENEMY, PLAYER_SPOTTED_ENEMY, PLAYER_ASSIST_TO_KILL_ENEMY, PLAYER_ASSIST_TO_STUN_ENEMY, PLAYER_USED_ARMOR, PLAYER_CAPTURED_BASE, PLAYER_DROPPED_CAPTURE, VEHICLE_HEALTH, VEHICLE_HIT, VEHICLE_CRITICAL_HIT, VEHICLE_CRITICAL_HIT_DAMAGE, VEHICLE_RICOCHET, VEHICLE_ARMOR_PIERCED, VEHICLE_DEAD, VEHICLE_SHOW_MARKER, VEHICLE_ATTRS_CHANGED, VEHICLE_IN_FOCUS, VEHICLE_HAS_AMMO, SHOW_VEHICLE_DAMAGES_DEVICES, HIDE_VEHICLE_DAMAGES_DEVICES, MINIMAP_SHOW_MARKER, MINIMAP_MARK_CELL, DAMAGE_LOG_SUMMARY, POSTMORTEM_SUMMARY, ENEMY_DAMAGED_HP_PLAYER, ENEMY_DAMAGED_DEVICE_PLAYER, VEHICLE_VISIBILITY_CHANGED, VEHICLE_STUN = range(1, 31)


MARKER_HIT_STATE = {FEEDBACK_EVENT_ID.VEHICLE_HIT: ('hit', ''),
 FEEDBACK_EVENT_ID.VEHICLE_CRITICAL_HIT: None,
 FEEDBACK_EVENT_ID.VEHICLE_CRITICAL_HIT_DAMAGE: None,
 FEEDBACK_EVENT_ID.VEHICLE_RICOCHET: None,
 FEEDBACK_EVENT_ID.VEHICLE_ARMOR_PIERCED: ('hit_pierced', '')}
MARKER_HIT_STATE_BOOTCAMP = {FEEDBACK_EVENT_ID.VEHICLE_HIT: ('hit_blocked', '#bootcamp:MARKER_BLOCKED'),
 FEEDBACK_EVENT_ID.VEHICLE_CRITICAL_HIT: ('hit_critical', '#bootcamp:MARKER_CRITICAL'),
 FEEDBACK_EVENT_ID.VEHICLE_CRITICAL_HIT_DAMAGE: ('hit_critical_damage', ''),
 FEEDBACK_EVENT_ID.VEHICLE_RICOCHET: ('hit_ricochet', '#bootcamp:MARKER_RICOCHET'),
 FEEDBACK_EVENT_ID.VEHICLE_ARMOR_PIERCED: ('hit_pierced', '')}
...
class STRATEGIC_CAMERA_ID(object):
    ...
    AERIAL = 1
    TRAJECTORY = 2
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\battle_control\battle_constants.pyc 
