# 2017.08.29 21:49:15 Støední Evropa (letní èas)
...
class stored_window(object):
    ...
    def __init__(self, dataType, targetID, sideEffect = None):
        ...
        if not (sideEffect is not None and callable(sideEffect)):
            raise AssertionError('Value of sideEffect is not callable')
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\managers\windows_stored_data.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:49:16 Støední Evropa (letní èas)
