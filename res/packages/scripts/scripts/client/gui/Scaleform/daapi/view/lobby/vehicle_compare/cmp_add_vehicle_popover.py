...
class VehicleCompareAddVehiclePopover(VehicleCompareAddVehiclePopoverMeta, VehicleSelectorBase):
    ...
    def addButtonClicked(self):
        ...
        raise vehicles or AssertionError
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\vehicle_compare\cmp_add_vehicle_popover.pyc 
