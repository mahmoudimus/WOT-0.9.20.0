# 2017.08.29 21:46:55 Støední Evropa (letní èas)
...
class FortReserveSelectPopover(FittingSelectPopoverMeta, IUnitListener):
    ...
    def __buildList(self):
        ...
        if entity is None:
            ...
            return modulesList
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\FortReserveSelectPopover.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:46:56 Støední Evropa (letní èas)
