...
class QueuedVehicleDossierReceiver(object):
    ...
    def dispose(self):
        self.__queuedVehicleData = None
        return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\profile\QueuedVehicleDossierReceiver.pyc 
