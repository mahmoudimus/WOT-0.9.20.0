# 2017.08.29 21:47:47 Støední Evropa (letní èas)
...
class _TradeInDataProvider(SortableDAAPIDataProvider):
    ...
    def _getItemPriceActionData(self, vehicle):
        if vehicle.buyPrices.itemPrice.isActionPrice():
            ...
            return None
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\tradein\TradeInPopup.pyc 
