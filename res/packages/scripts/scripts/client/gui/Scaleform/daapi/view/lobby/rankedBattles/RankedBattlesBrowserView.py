...
class RankedBattlesBrowserView(RankedBattlesBrowserViewMeta):
    ...
    def __updateSkipEscape(self):
        ...
        return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\rankedBattles\RankedBattlesBrowserView.pyc 
