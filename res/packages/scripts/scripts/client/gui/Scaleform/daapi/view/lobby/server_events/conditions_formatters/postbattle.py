# 2017.08.29 21:47:36 Støední Evropa (letní èas)
...
class _VehiclesStunFormatter(_VehicleTableFormatter):
    ...
    def _getLabelKey(cls, condition = None):
        ...
        return key
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\server_events\conditions_formatters\postbattle.pyc 
