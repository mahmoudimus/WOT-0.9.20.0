...
class SettingsParams(object):
    ...
    def getApplyMethod(self, diff):
        ...
        return self.settingsCore.getApplyMethod(diff)
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\common\settings\SettingsParams.pyc 
