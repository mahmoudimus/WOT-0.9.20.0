# 2017.08.29 21:46:07 Støední Evropa (letní èas)
...
class PostmortemPanel(_SummaryPostmortemPanel):
    ...
    def __showPlayerInfo(self):
        raise self.__playerInfo is not None or AssertionError('Player info must be defined at first, see vehicle_state_ctrl')
    ...
    def __onSettingsChanged(self, diff):
        if GRAPHICS.COLOR_BLIND in diff:
            ...
            self.__deathAlreadySet = False
            self.__updateVehicleInfo()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\battle\shared\postmortem_panel.pyc 
