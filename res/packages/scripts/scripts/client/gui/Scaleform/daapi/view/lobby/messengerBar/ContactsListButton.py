# 2017.08.29 21:47:08 Støední Evropa (letní èas)
...
class ContactsListButton(ButtonWithCounterMeta):
    ...
    def __showContactsCount(self):
        ...
        if count != self.__count:
            self.__count = count
            self.as_setCountS(self.__count)
    ...
    def __me_onUserActionReceived(self, actionID, user):
        ...
        self.__showContactsCount()
        return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\messengerBar\ContactsListButton.pyc 
