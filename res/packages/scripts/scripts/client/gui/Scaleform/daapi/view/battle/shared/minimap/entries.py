...
class VehicleEntry(MinimapEntry):
    ...
    def updatePosition(self, position):
        ...
        :return:
        """
        raise self._location == VEHICLE_LOCATION.FAR or AssertionError
    ...
    def getSpottedAnimation(self, pool):
        ...
        return animation
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\battle\shared\minimap\entries.pyc 
