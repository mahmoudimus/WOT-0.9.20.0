# 2017.08.29 21:47:29 Støední Evropa (letní èas)
...
class RankedBattlesPrimeTimeView(LobbySubView, RankedBattlesPrimeTimeMeta, Notifiable, IPreQueueListener):
    ...
    def __continue(self):
        ...
        if result:
            self.__close()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\rankedBattles\ranked_battles_prime_time_view.pyc 
