...
class PlayerMessages(fading_messages.FadingMessages):
    ...
    def __onCombatEquipmentUsed(self, shooterID, eqID):
        ...
        return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\battle\shared\messages\player_messages.pyc 
