...
class BuyBoosterMeta(I18nConfirmDialogMeta):
    ...
    def getActionVO(self):
        if self.__boosterBuyPricesSum.isActionPrice():
            return packActionTooltipData(ACTION_TOOLTIPS_TYPE.BOOSTER, str(self.__booster.boosterID), True, self.__boosterBuyPricesSum.price, self.__boosterBuyPricesSum.defPrice)
        else:
            return None
