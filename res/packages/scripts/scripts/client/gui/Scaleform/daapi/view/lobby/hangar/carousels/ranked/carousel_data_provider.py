...
class RankedCarouselDataProvider(HangarCarouselDataProvider):
    ...
    def _buildVehicle(self, vehicle):
        ...
        return result
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\hangar\carousels\ranked\carousel_data_provider.pyc 
