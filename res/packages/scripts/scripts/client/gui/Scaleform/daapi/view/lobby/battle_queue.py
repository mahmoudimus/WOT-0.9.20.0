# 2017.08.29 21:46:31 Støední Evropa (letní èas)
...
class BattleQueue(BattleQueueMeta, LobbySubView):
    ...
    def __updateTimer(self):
        ...
        self.__createTime += 1
        return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\battle_queue.pyc 
