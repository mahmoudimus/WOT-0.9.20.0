...
class MarkersManager(ExternalFlashComponent, VehicleMarkersManagerMeta, plugins.IMarkersManager):
    ...
    def setMarkerActive(self, markerID, active):
        ...
        """
        raise markerID in self.__ids or AssertionError('Marker is not added by given ID')
    ...
    def __destroyPlugins(self):
        if self.__plugins is not None:
            ...
            self.__plugins.fini()
        return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\battle\shared\markers2d\manager.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:46:12 Støední Evropa (letní èas)
