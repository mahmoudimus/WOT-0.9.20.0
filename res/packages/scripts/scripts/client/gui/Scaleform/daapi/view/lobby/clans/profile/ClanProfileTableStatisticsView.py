...
class _ClanProfileProvinceDataProvider(SortableDAAPIDataProvider):
    ...
    def __isRobbed(self, province):
        ...
        return isRobbed
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\clans\profile\ClanProfileTableStatisticsView.pyc 
