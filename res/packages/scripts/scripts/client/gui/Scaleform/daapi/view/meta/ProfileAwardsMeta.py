...
class ProfileAwardsMeta(ProfileAchievementSection):

    def setFilter(self, data):
        self._printOverrideError('setFilter')
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\meta\ProfileAwardsMeta.pyc 
