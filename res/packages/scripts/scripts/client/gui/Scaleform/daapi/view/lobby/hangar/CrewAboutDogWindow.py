# 2017.08.29 21:46:58 Støední Evropa (letní èas)
...
class CrewAboutDogWindow(SimpleWindowMeta):
    ...
    def getBtnData(self):
        return [{'label': MENU.HANGAR_CREW_RODY_DOG_WINDOW_CLOSEBTNLABEL,
          ...
          'isFocused': True,
          'tooltip': ''}]
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\hangar\CrewAboutDogWindow.pyc 
