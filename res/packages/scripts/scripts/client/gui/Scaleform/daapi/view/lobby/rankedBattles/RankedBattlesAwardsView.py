...
class RankedBattlesAwardsView(RankedBattlesAwardsViewMeta):
    ...
    def __init__(self, ctx = None):
        ...
        raise 'rankID' in ctx or AssertionError
    ...
    def __close(self):
        self.destroy()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\rankedBattles\RankedBattlesAwardsView.pyc 
