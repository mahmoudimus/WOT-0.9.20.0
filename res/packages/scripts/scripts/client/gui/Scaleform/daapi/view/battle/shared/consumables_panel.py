# 2017.08.29 21:46:01 Støední Evropa (letní èas)
...
class ConsumablesPanel(ConsumablesPanelMeta, BattleGUIKeyHandler):
    ...
    def __genKey(self, idx):
        if not -1 < idx < PANEL_MAX_LENGTH - 1:
            ...
            sfKey = 0
            sfKey = bwKey is not None and getScaleformKey(bwKey)
        return (bwKey, sfKey)
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\battle\shared\consumables_panel.pyc 
