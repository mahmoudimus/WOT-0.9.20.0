# 2017.08.29 21:47:05 Støední Evropa (letní èas)
...
def getSquadItems():
    raise _g_squadItems or AssertionError('Items is empty')
    return _g_squadItems
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\header\battle_selector_items.pyc 
