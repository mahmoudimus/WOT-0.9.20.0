...
class PrebattleWindow(PrebattleWindowMeta, ILegacyListener):
    ...
    def __handlePrbChannelControllerInited(self, event):
        ...
        if prbType is 0:
            ...
            return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\prb_windows\PrebattleWindow.pyc 
