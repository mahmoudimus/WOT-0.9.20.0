...
class QuestsContentTabs(QuestsContentTabsMeta):
    ...
    def __packViewTabDataItem(self, label, tabId):
        return {'label': label,
         'id': tabId}
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\server_events\QuestsContentTabs.pyc 
