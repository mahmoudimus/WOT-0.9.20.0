# 2017.08.29 21:45:52 Støední Evropa (letní èas)
...
class BattleResultsWindow(BattleResultsMeta):
    ...
    def __canNavigate(cls):
        ...
        if prbDispatcher is not None and prbDispatcher.getFunctionalState().isNavigationDisabled():
            ...
            return True
            return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\battle_results_window.pyc 
