# 2017.08.29 21:47:49 Støední Evropa (letní èas)
...
class VehiclePreview(LobbySubView, VehiclePreviewMeta):
    ...
    def __handleWindowClose(self, _):
        self.onBackClick()
        self.destroy()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\vehiclePreview\VehiclePreview.pyc 
