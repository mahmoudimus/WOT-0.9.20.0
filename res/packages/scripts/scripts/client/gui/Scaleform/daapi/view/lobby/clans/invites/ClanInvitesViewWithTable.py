...
class ClanInvitesAbstractDataProvider(SortableDAAPIDataProvider):
    ...
    def __formatActiveStateString(self, item):
        ...
        return state
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\clans\invites\ClanInvitesViewWithTable.pyc 
