...
class _BattleMapFormatter(ConditionFormatter):
    ...
    def _format(self, condition, event):
        ...
        return result
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\missions\conditions_formatters\prebattle.pyc 
