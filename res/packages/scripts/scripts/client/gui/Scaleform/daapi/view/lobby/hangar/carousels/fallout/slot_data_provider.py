...
class SlotDataProvider(SortableDAAPIDataProvider):
    ...
    def _dispose(self):
        ...
        return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\hangar\carousels\fallout\slot_data_provider.pyc 
