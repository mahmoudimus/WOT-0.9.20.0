...
class EquipmentsMarkerPlugin(MarkerPlugin):
    ...
    def __handleCallback(self, markerID, finishTime):
        ...
        return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\battle\shared\markers2d\plugins.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:46:13 Støední Evropa (letní èas)
