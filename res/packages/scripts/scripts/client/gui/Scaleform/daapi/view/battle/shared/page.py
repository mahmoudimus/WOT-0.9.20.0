...
class ComponentsConfig(IComponentsConfig):
    ...
    def __doAdd(self, other):
        raise isinstance(other, ComponentsConfig) or AssertionError('Invalid item Addition!')
...
class BattlePageBusinessHandler(PackageBusinessHandler):
    ...
    def __loadPage(self, event):
        ...
        return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\battle\shared\page.pyc 
