# 2017.08.29 21:46:34 Støední Evropa (letní èas)
...
class ModuleInfoWindow(ModuleInfoMeta):
    ...
    def __init__(self, ctx = None):
        ...
        raise self.moduleCompactDescr or AssertionError('module compact descriptor must be defined')
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\ModuleInfoWindow.pyc 
