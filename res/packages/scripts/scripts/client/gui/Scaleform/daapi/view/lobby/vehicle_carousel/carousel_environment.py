# 2017.08.29 21:47:50 Støední Evropa (letní èas)
...
class CarouselEnvironment(CarouselEnvironmentMeta, IGlobalListener):
    ...
    def __onVehicleClientStateChanged(self, vehicles):
        self.updateVehicles(vehicles)
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\vehicle_carousel\carousel_environment.pyc 
