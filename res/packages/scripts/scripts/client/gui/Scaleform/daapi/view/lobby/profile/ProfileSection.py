# 2017.08.29 21:47:19 Støední Evropa (letní èas)
...
class ProfileSection(ProfileSectionMeta):
    ...
    def _formIconLabelInitObject(self, i18key, icon):
        return {'description': i18n.makeString(i18key),
         'icon': icon}
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\profile\ProfileSection.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:47:20 Støední Evropa (letní èas)
