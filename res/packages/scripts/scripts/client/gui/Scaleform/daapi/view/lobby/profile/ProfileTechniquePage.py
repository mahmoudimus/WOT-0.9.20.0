...
class ProfileTechniquePage(ProfileTechniquePageMeta):
    ...
    def requestData(self, vehicleId):
        ...
        return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\profile\ProfileTechniquePage.pyc 
