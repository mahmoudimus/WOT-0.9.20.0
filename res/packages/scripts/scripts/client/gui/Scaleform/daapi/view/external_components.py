# 2017.08.29 21:45:53 Støední Evropa (letní èas)
...
class ExternalFlashComponent(Flash, IExternalFlashComponent):
    ...
    def __init__(self, settings):
        ...
        raise isinstance(settings, ExternalFlashSettings) or AssertionError('Settings are invalid')
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\external_components.pyc 
