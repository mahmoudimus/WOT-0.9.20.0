...
class _UnitResultsFormatter(SimpleMissionsFormatter):
    ...
    def _getIconKey(cls, condition = None):
        return CONDITION_ICON.SURVIVE
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\missions\conditions_formatters\postbattle.pyc 
