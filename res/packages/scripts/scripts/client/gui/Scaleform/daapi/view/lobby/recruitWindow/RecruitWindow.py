...
class RecruitWindow(RecruitWindowMeta):
    ...
    def buyTankman(self, nationID, vehTypeID, role, studyType, slot):
        ...
        self.onWindowClose()
        return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\recruitWindow\RecruitWindow.pyc 
