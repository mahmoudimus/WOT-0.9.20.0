...
class VehCompareBasketParamsCache(object):
    ...
    def __onVehParamsChanged(self, data):
        ...
        return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\vehicle_compare\cmp_parameters.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:47:55 Støední Evropa (letní èas)
