...
class TechnicalMaintenance(TechnicalMaintenanceMeta):
    ...
    def __getStatus(self, reason):
        if reason is not None:
            ...
            return ''
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\hangar\TechnicalMaintenance.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:47:02 Støední Evropa (letní èas)
