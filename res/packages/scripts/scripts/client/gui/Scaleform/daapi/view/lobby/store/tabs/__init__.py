...
class StoreOptionalDeviceTab(StoreArtefactTab):
    ...
    def _getItemHighlightType(self, item):
        ...
        return super(StoreOptionalDeviceTab, self)._getItemHighlightType(item)
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\store\tabs\__init__.pyc 
