...
class DamageInfoPanel(DamageInfoPanelMeta):
    ...
    def __onVehicleControlling(self, vehicle):
        self.__hide()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\battle\shared\damage_info_panel.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:46:02 Støední Evropa (letní èas)
