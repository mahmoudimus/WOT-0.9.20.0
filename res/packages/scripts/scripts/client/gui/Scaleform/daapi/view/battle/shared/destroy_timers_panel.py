# 2017.08.29 21:46:03 Støední Evropa (letní èas)
...
class DestroyTimersPanel(DestroyTimersPanelMeta):
    ...
    def __init__(self, mapping = None):
        ...
        if not (mapping is not None and isinstance(mapping, _mapping.FrontendMapping)):
    ...
    def __onCameraChanged(self, ctrlMode, vehicleID = None):
        if ctrlMode == 'video':
            self.__hideAll()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\battle\shared\destroy_timers_panel.pyc 
