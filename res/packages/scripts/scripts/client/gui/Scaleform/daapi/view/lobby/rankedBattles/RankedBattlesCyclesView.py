...
class RankedBattlesCyclesView(LobbySubView, RankedBattlesCyclesViewMeta):
    ...
    def __extractBonusesForAwardRibbon(quests):
        ...
        return bonusesDict
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\rankedBattles\RankedBattlesCyclesView.pyc 
