...
class _AwardsBlockBuilder(object):
    ...
    def __packBlockData(cls, blockID, data):
        ...
        result.update(data)
        return result
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\rankedBattles\RankedBattlesView.pyc 
