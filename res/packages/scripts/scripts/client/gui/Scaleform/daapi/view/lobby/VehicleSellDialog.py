# 2017.08.29 21:46:38 Støední Evropa (letní èas)
...
class VehicleSellDialog(VehicleSellDialogMeta):
    ...
    def __shopResyncHandler(self, reason, diff):
        ...
        if reason == CACHE_SYNC_REASON.SHOP_RESYNC or vehicle is not None and vehicle.rentalIsActive:
            self.onWindowClose()
        return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\VehicleSellDialog.pyc 
