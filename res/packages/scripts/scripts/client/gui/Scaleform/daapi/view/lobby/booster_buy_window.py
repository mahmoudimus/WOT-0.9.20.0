...
class BoosterBuyWindow(BoosterBuyWindowMeta):
    ...
    def __init__(self, ctx = None):
        ...
        raise self.__item.itemTypeID == GUI_ITEM_TYPE.BATTLE_BOOSTER or AssertionError
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\booster_buy_window.pyc 
