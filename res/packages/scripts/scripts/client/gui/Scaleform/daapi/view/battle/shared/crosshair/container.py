...
class CrosshairPanelContainer(ExternalFlashComponent, CrosshairPanelContainerMeta):
    ...
    def __clearGunMarkers(self):
        if self.__gunMarkers is None:
            ...
            self.__gunMarkers = None
            return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\battle\shared\crosshair\container.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:46:10 Støední Evropa (letní èas)
