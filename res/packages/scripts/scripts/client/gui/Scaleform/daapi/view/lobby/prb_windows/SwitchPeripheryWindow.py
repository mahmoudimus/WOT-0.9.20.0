# 2017.08.29 21:47:18 Støední Evropa (letní èas)
...
class SwitchPeripheryWindow(SwitchPeripheryWindowMeta, Notifiable):
    ...
    def __onServersUpdate(self, *args):
        self._updateServersList()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\prb_windows\SwitchPeripheryWindow.pyc 
