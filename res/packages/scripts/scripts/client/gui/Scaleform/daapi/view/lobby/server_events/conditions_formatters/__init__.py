...
class QuestsBattleConditionsFormatter(ConditionsFormatter):
    ...
    def format(self, conditions, event):
        ...
        return result
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\server_events\conditions_formatters\__init__.pyc 
