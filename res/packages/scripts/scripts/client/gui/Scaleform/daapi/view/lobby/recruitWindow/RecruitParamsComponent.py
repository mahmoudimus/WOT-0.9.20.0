# 2017.08.29 21:47:31 Støední Evropa (letní èas)
...
class RecruitParamsComponent(RecruitParametersMeta):
    ...
    def __getTankmanRoleEmptyRow(self):
        return {'id': None,
         'label': DIALOGS.RECRUITWINDOW_MENUEMPTYROW}
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\recruitWindow\RecruitParamsComponent.pyc 
