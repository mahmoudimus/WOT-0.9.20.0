...
class CarouselDataProvider(SortableDAAPIDataProvider):
    ...
    def _vehicleComparisonKey(cls, vehicle):
        ...
        return (not vehicle.isInInventory,
         ...
         vehicle.userName)
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\vehicle_carousel\carousel_data_provider.pyc 
