...
class _InnerAndGroupFormatter(GroupFormatter):
    ...
    def _format(self, condition, event):
        ...
        return andResults
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\missions\conditions_formatters\__init__.pyc 
