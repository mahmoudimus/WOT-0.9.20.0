...
# Embedded file name: scripts/client/gui/Scaleform/daapi/view/battle/shared/stats_exchage/broker.py
import weakref
...
class ExchangeBlock(IExternalExchangeComponent):
    ...
    def __init__(self, component, composer = None):
        raise isinstance(component, ExchangeComponent) or AssertionError('Exchange is invalid')
    ...
    def setCtx(self, ctx):
        raise isinstance(ctx, ExchangeCtx) or AssertionError('Context is invalid')
...
class ExchangeBroker(object):
    ...
    def setVehiclesInfoExchange(self, exchange):
        raise isinstance(exchange, ExchangeBlock) or AssertionError('Exchange is invalid')
    ...
    def setVehicleStatusExchange(self, exchange):
        raise isinstance(exchange, ExchangeComponent) or AssertionError('Exchange is invalid')
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\battle\shared\stats_exchage\broker.pyc 
