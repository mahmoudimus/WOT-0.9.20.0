    ...
    def _updateDummy(self):
        if self.clansCtrl.isAvailable() and not self._dummyMustBeShown:
            ...
            self.as_showDummyS({'iconSource': RES_ICONS.MAPS_ICONS_LIBRARY_ALERTBIGICON,
             ...
             'btnLabel': '',
             'btnTooltip': ''})
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\clans\profile\ClanProfileBaseView.pyc 
