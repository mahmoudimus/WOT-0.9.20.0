...
class MissionsFilterPopoverView(MissionsFilterPopoverViewMeta):
    ...
    def __getInitialVO(self):
        ...
        return dataVO
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\missions\missions_filter_popover.pyc 
