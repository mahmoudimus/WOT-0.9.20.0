# 2017.08.29 21:45:57 Støední Evropa (letní èas)
...
class FalloutMarkersManager(MarkersManager):
    ...
    def _setupPlugins(self, arenaVisitor):
        ...
        return setup
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\battle\fallout\markers2d.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:45:58 Støední Evropa (letní èas)
