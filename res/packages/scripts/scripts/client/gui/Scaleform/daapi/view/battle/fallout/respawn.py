# 2017.08.29 21:45:59 Støední Evropa (letní èas)
...
class FalloutRespawn(FalloutRespawnViewMeta, IRespawnView):
    ...
    def __getVehicleName(self, vehicle):
        if isPremiumIGR(vehicle.type.tags):
            return makeHtmlString('html_templates:igr/premium-vehicle', 'name', {'vehicle': vehicle.type.shortUserString})
        return vehicle.type.userString
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\battle\fallout\respawn.pyc 
