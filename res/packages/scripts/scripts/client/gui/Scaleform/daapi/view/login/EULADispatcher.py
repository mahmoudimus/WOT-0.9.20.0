# 2017.08.29 21:47:56 Støední Evropa (letní èas)
...
class _LicenseXMLProcessor(object):
    ...
    def execute(self, section, processor = None, result = None):
        ...
        return result
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\login\EULADispatcher.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:47:57 Støední Evropa (letní èas)
