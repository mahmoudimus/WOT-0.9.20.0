...
class ClanProfileMainWindow(ClanProfileMainWindowMeta, ClanListener):
    ...
    def __closeClanProfileHandler(self, _):
        self.destroy()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\clans\profile\ClanProfileMainWindow.pyc 
