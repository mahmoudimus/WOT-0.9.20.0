# 2017.08.29 21:47:00 Støední Evropa (letní èas)
...
class RankedBattleResultsFinalWidget(RankedBattlesWidget):
    ...
    def _getCountLabel(self, rank):
        if rank.hasProgress():
            return rank.getProgress().getUserStr()
        return ''
...
class RankedBattleResultsWidget(RankedBattleResultsFinalWidget):
    ...
    def _isMuted(self):
        return False
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\hangar\ranked_battles_widget.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:47:01 Støední Evropa (letní èas)
