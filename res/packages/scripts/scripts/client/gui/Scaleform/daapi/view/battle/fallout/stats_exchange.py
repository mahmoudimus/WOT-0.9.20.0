...
class FalloutStatisticsDataController(BattleStatisticsDataController):
    ...
    def __configureMultiTeamBroker(self, exchangeBroker):
        ...
        return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\battle\fallout\stats_exchange.pyc 
