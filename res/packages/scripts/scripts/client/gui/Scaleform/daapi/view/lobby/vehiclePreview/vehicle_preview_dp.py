...
class DefaultVehPreviewDataProvider(IVehPreviewDataProvider):
    ...
    def __packTabButtonsData(self):
        ...
        return data
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\vehiclePreview\vehicle_preview_dp.pyc 
