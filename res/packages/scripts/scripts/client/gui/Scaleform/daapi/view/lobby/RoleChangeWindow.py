# 2017.08.29 21:46:36 Støední Evropa (letní èas)
...
def _getTooltipHeader(tankmenCountWithSameRole, isAvailable):
    if tankmenCountWithSameRole > 0 and isAvailable:
        return _ms(TOOLTIPS.ROLECHANGE_ROLEANDVEHICLETAKEN_HEADER)
    return ''
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\RoleChangeWindow.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:46:37 Støední Evropa (letní èas)
