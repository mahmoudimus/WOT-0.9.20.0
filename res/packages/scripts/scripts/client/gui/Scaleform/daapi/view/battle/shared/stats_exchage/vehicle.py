...
class VehiclesExchangeBlock(broker.ExchangeBlock):
    ...
    def addTotalStats(self, stats):
        for composer in self._statsComposers:
            composer.addTotalStats(stats)
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\battle\shared\stats_exchage\vehicle.pyc 
