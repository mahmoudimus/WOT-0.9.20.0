# 2017.08.29 21:47:12 Støední Evropa (letní èas)
...
class _CumulativableFormatter(MissionFormatter, CumulativableFormatter):
    ...
    def _getProgressData(self, condition, event):
        ...
        if len(result) and rendererLinkage is not None:
...
class _CumulativeResultFormatter(_CumulativableFormatter):
    ...
    def _packGui(self, title, condition, progressType, current, total, progressData = None):
        ...
        return formatters.packMissionIconCondition(title, progressType, description, iconKey, current=current, total=total, progressData=progressData)
...
class _VehicleKillsCumulativeFormatter(_VehicleCumulativeFormatter, _VehiclesKillFormatter):
    """
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\missions\conditions_formatters\bonus.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:47:13 Støední Evropa (letní èas)
