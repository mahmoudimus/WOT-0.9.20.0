...
class ViewContainer(object):
    ...
    def removeView(self, pyView):
        ...
        if container is None:
            ...
            return False
        elif pyView.key in container._views:
    ...
    def removeLoadingView(self, pyView):
        ...
        if container is None:
            ...
            return False
        elif pyView.key in container._loadingViews:
...
class SingleViewContainer(ViewContainer):
    ...
    def __init__(self, viewType, manager = None):
        raise viewType not in _POPUPS_CONTAINERS or AssertionError('Type of view can not be {}'.format(viewType))
...
class _LoadingChain(object):
    ...
    def __init__(self, chainItems):
        ...
        for item in chainItems:
            raise isinstance(item, ChainItem) or AssertionError
            viewKey = item.loadParams.viewKey
            raise viewKey not in self.__queue or AssertionError
...
class ContainerManager(ContainerManagerMeta, IContainerManager):
    ...
    def __onViewLoaded(self, pyView, loadParams):
        ...
        if loadMode == ViewLoadMode.DEFAULT:
            ...
            pyView.destroy()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\framework\managers\containers.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:48:37 Støední Evropa (letní èas)
