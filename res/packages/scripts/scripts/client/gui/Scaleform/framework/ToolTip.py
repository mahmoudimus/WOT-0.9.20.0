# 2017.08.29 21:48:31 Støední Evropa (letní èas)
...
class ToolTip(ToolTipMgrMeta):
    ...
    def __getTags(self, block_type, format_type):
        ...
        return ['', '']
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\framework\ToolTip.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:48:32 Støední Evropa (letní èas)
