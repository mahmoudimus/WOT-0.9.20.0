...
class WAITING(object):
    ...
    C_UPDATECAPTUREDEVICES = '#waiting:__updateCaptureDevices'
    ...
    def message(cls, key0):
        ...
        if outcome not in cls.MESSAGE_ENUM:
            ...
            return outcome
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\locale\WAITING.pyc 
