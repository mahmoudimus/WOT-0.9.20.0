# 2017.08.29 21:48:48 Støední Evropa (letní èas)
...
class DIALOGS(object):
    ...
    SELLCONFIRMATION_MESSAGECOMBINETANKMEN = '#dialogs:sellConfirmation/messageCombineTankmen'
    SELLCONFIRMATION_MESSAGECOMBINEDEVICES = '#dialogs:sellConfirmation/messageCombineDevices'
    SELLCONFIRMATION_MESSAGECOMBINEEQUIPMENT = '#dialogs:sellConfirmation/messageCombineEquipment'
    SELLCONFIRMATION_MESSAGECOMBINEQUESTION = '#dialogs:sellConfirmation/messageCombineQuestion'
    ...
    CUSTOMIZATION_CHANGECONFIRMATION_CANCEL = '#dialogs:customization/changeConfirmation/cancel'
    ...
    TECHNICALMAINTENANCECONFIRM_MSG_POPULATE = '#dialogs:technicalMaintenanceConfirm/msg_populate'
    TECHNICALMAINTENANCECONFIRM_MSG_UNLOAD = '#dialogs:technicalMaintenanceConfirm/msg_unload'
    TECHNICALMAINTENANCECONFIRM_MSG_ORDER_CHANGE = '#dialogs:technicalMaintenanceConfirm/msg_order_change'
    TECHNICALMAINTENANCECONFIRM_MSG_REPAIR = '#dialogs:technicalMaintenanceConfirm/msg_repair'
    TECHNICALMAINTENANCECONFIRM_MSG_REPAIR_POPULATE = '#dialogs:technicalMaintenanceConfirm/msg_repair_populate'
    TECHNICALMAINTENANCECONFIRM_MSG_REPAIR_UNLOAD = '#dialogs:technicalMaintenanceConfirm/msg_repair_unload'
    TECHNICALMAINTENANCECONFIRM_MSG_REPAIR_ORDER_CHANGE = '#dialogs:technicalMaintenanceConfirm/msg_repair_order_change'
    ...
    ALL_ENUM = (INTERVIEWQUIT_TITLE,
     ...
     SELLCONFIRMATION_MESSAGECOMBINETANKMEN,
     SELLCONFIRMATION_MESSAGECOMBINEDEVICES,
     SELLCONFIRMATION_MESSAGECOMBINEEQUIPMENT,
     SELLCONFIRMATION_MESSAGECOMBINEQUESTION,
     ...
     CUSTOMIZATION_CHANGECONFIRMATION_CANCEL,
     TECHNICALMAINTENANCECONFIRM_TITLE,
     TECHNICALMAINTENANCECONFIRM_MESSAGE,
     TECHNICALMAINTENANCECONFIRM_MSG_POPULATE,
     TECHNICALMAINTENANCECONFIRM_MSG_UNLOAD,
     TECHNICALMAINTENANCECONFIRM_MSG_ORDER_CHANGE,
     TECHNICALMAINTENANCECONFIRM_MSG_REPAIR,
     TECHNICALMAINTENANCECONFIRM_MSG_REPAIR_POPULATE,
     TECHNICALMAINTENANCECONFIRM_MSG_REPAIR_UNLOAD,
     TECHNICALMAINTENANCECONFIRM_MSG_REPAIR_ORDER_CHANGE,
    ...
    def all(cls, key0):
        ...
        if outcome not in cls.ALL_ENUM:
            ...
            return outcome
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\locale\DIALOGS.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:48:54 Støední Evropa (letní èas)
