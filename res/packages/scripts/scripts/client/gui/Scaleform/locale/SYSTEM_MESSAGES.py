# 2017.08.29 21:49:02 Støední Evropa (letní èas)
...
class SYSTEM_MESSAGES(object):
    ...
    def all(cls, key0):
        ...
        if outcome not in cls.ALL_ENUM:
            ...
            return outcome
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\locale\SYSTEM_MESSAGES.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:49:11 Støední Evropa (letní èas)
