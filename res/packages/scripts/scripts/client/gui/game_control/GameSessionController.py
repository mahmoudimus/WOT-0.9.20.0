# 2017.08.29 21:45:03 Støední Evropa (letní èas)
...
class GameSessionController(IGameSessionController, Notifiable):
    ...
    def __getCurfewBlockTime(cls, restrictions):
        ...
        return (None, None)
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\game_control\GameSessionController.pyc 
