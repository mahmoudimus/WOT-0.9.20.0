# 2017.08.29 21:45:01 Støední Evropa (letní èas)
...
class BrowserController(IBrowserController):
    ...
    def __showBrowser(self, browserID, ctx):
        ...
        if showBrowserCallback:
            showBrowserCallback()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\game_control\BrowserController.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:45:02 Støední Evropa (letní èas)
