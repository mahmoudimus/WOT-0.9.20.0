# 2017.08.29 21:45:04 Støední Evropa (letní èas)
...
class PromoController(IPromoController):
    ...
    def __showPromoBrowser(self, promoUrl, promoTitle, browserID = None, isAsync = True, showWaiting = False, callback = None):
        ...
        callback(browserID)
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\game_control\PromoController.pyc 
