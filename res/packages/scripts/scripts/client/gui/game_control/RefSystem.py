...
class _RefItem(object):
    ...
    def getBonusTimeLeftStr(self):
        ...
        return ''
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\game_control\RefSystem.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:45:07 Støední Evropa (letní èas)
