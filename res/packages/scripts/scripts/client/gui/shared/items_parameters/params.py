...
class VehicleParams(_ParameterBase):
    ...
    def turretArmor(self):
        if self.__hasTurret():
            return self._itemDescr.turret.primaryArmor
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\shared\items_parameters\params.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:49:59 Støední Evropa (letní èas)
