# 2017.08.29 21:49:57 Støední Evropa (letní èas)
...
def formatParameterDelta(pInfo, deltaScheme = BASE_SCHEME, formatSettings = DELTA_PARAMS_SETTING):
    ...
    if diff:
        return formatParameter(pInfo.name, diff, pInfo.state, deltaScheme, formatSettings, allowSmartRound=False)
    else:
        return None
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\shared\items_parameters\formatters.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:49:58 Støední Evropa (letní èas)
