# 2017.08.29 21:50:07 Støední Evropa (letní èas)
...
class TokensAwardTooltipData(SeasonAwardTooltipData):
    ...
    def _packBlocks(self, *args, **kwargs):
        ...
        return blocks
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\shared\tooltips\potapovquests.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:50:08 Støední Evropa (letní èas)
