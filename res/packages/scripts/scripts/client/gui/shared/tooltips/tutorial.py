# 2017.08.29 21:50:10 Støední Evropa (letní èas)
...
class EquipmentPacker(HeaderPacker):
    ...
    def _packBlocks(self, *args, **kwargs):
        ...
        return items
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\shared\tooltips\tutorial.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:50:11 Støední Evropa (letní èas)
