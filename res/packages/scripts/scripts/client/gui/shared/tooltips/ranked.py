# 2017.08.29 21:50:09 Støední Evropa (letní èas)
...
class RankedTooltipData(BlocksTooltipData):
    ...
    def _packAwardsBlock(self, quest):
        ...
        return subBlocks
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\shared\tooltips\ranked.pyc 
