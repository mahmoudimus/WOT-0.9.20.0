# 2017.08.29 21:50:04 Støední Evropa (letní èas)
...
class InventoryBattleBoosterContext(ShopBattleBoosterContext):
    ...
    def getStatusConfiguration(self, item):
        ...
        value.checkBuying = False
        return value
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\shared\tooltips\contexts.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:50:05 Støední Evropa (letní èas)
