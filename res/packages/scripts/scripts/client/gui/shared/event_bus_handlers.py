# 2017.08.29 21:49:29 Støední Evropa (letní èas)
...
def _disposeWrapper(method):
    ...
    return wrapped
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\shared\event_bus_handlers.pyc 
