...
class RentLeftFormatter(object):
    ...
    def getRentWinsLeftStr(self, localization = None, formatter = None):
        ...
        if winsLeft > 0:
            return formatter(localization, 'wins', winsLeft)
        else:
            return ''
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\shared\formatters\time_formatters.pyc 
