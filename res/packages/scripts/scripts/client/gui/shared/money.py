# 2017.08.29 21:49:30 Støední Evropa (letní èas)
...
class Money(object):
    ...
    def exchange(self, currency, toCurrency, rate, default = None):
        ...
        """
        raise currency != toCurrency or AssertionError
        raise currency in self.__values or AssertionError
    ...
    def makeFromMoneyTuple(cls, moneyTuple):
        ...
        :return: A new instance of Money class.
        """
        raise isinstance(moneyTuple, (tuple, list)) or AssertionError
...
class CurrencyCollection(_CurrencyCollection):
    ...
    def __iter__(self):
        ...
        for c in Currency.ALL:
            yield self.get(c)
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\shared\money.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:49:31 Støední Evropa (letní èas)
