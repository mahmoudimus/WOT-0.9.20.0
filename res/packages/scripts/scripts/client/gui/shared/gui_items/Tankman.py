# 2017.08.29 21:49:36 Støední Evropa (letní èas)
...
class SabatonTankmanSkill(TankmanSkill):
    ...
    def getSkillUserName(self, skillName):
        ...
        """
        if skillName == 'brotherhood':
            return i18n.makeString(ITEM_TYPES.TANKMAN_SKILLS_BROTHERHOOD_SABATON)
...
def getTankmanSkill(skillName, tankman = None, proxy = None):
    if tankman and sabaton_crew.isSabatonCrew(tankman.descriptor):
...
def __makeFakeTankmanDescr(startRoleLevel, freeXpValue, typeID):
    ...
    return tmanDescr
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\shared\gui_items\Tankman.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:49:37 Støední Evropa (letní èas)
