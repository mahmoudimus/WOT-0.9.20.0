# 2017.08.29 21:49:34 Støední Evropa (letní èas)
...
class BattleBooster(Equipment):
    ...
    def getCrewBoosterDescription(self, isPerkReplace, formatter = None):
        ...
        if not self.isCrewBooster():
            ...
            formatted = formatter is None and description.format(action=action, skillOrPerk=skillOrPerk, name=skillName, colorTagOpen='', colorTagClose='')
        else:
    ...
    def getCrewBoosterAction(self, isPerkReplace):
        ...
        """
        raise self.isCrewBooster() or AssertionError('This action description is only for Crew Booster!')
    ...
    def getOptDeviceBoosterDescription(self, vehicle, valueFormatter = None):
        ...
        :return: formatted string
        """
        raise not self.isCrewBooster() or AssertionError('This description is only for Opt. Dev. Booster!')
...
# 2017.08.29 21:49:35 Støední Evropa (letní èas)
