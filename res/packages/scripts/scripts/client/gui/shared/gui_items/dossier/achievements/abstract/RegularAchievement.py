...
class RegularAchievement(GUIItem):
    ...
    def __cmp__(self, other):
        if isinstance(other, RegularAchievement):
            ...
            return 1
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\shared\gui_items\dossier\achievements\abstract\RegularAchievement.pyc 
