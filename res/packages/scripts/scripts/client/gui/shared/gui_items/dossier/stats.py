# 2017.08.29 21:49:40 Støední Evropa (letní èas)
...
class _VehiclesStatsBlock(_StatsBlockAbstract):
    ...
    def getMarkOfMasteryForVehicle(self, intCD):
        ...
        return MASTERY_IS_NOT_ACHIEVED
...
class _StoredRankedSeasonsStatsBlock(_RankedSeasonsStatsBlock):
    ...
    def getPrevSeasonLadderPts(self):
        ...
        if prevSeasonData:
            return prevSeasonData[self._LADDER_PTS_IDX]
        return 0
    ...
    def getPrevSeasonStepsCount(self):
        ...
        prevSeasonData = self.__getPreviousSeasonData()
        if prevSeasonData:
            return prevSeasonData[self._STEPS_COUNT_IDX]
        return 0
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\shared\gui_items\dossier\stats.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:49:41 Støední Evropa (letní èas)
