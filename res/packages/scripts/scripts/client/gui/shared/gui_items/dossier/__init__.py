...
class ClubMemberDossier(_Dossier, stats.ClubMemberDossierStats):
    ...
    def _getDossierItem(self):
        return self
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\shared\gui_items\dossier\__init__.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:49:42 Støední Evropa (letní èas)
