# 2017.08.29 21:45:27 Støední Evropa (letní èas)
...
class UnitEntity(_UnitEntity):
    ...
    def getVehiclesInfo(self, dbID = None, unitMgrID = None):
        ...
        vehicles = unit.getVehicles()
        if dbID in vehicles:
            return map(lambda vehicle: unit_items.VehicleInfo(**vehicle._asdict()), vehicles[dbID])
        else:
    ...
    def _isInCoolDown(self, requestType, callback = None, coolDown = None):
        ...
        if self._cooldown.validate(requestType, coolDown):
            ...
            return True
        return False
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\prb_control\entities\base\unit\entity.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:45:29 Støední Evropa (letní èas)
