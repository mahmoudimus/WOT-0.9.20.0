...
class ActionsValidatorComposite(BaseActionsValidator):
    ...
    def addValidator(self, validator):
        ...
        """
        raise isinstance(validator, IActionsValidator) or AssertionError
    ...
    def addWarning(self, warning):
        ...
        """
        raise isinstance(warning, IActionsValidator) or AssertionError
    ...
    def _validate(self):
        ...
        for warning in self.__warnings:
            ...
            if not (result is not None and result.isValid):
                raise AssertionError('Warnings could not be invalid!')
                return result

        return super(ActionsValidatorComposite, self)._validate()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\prb_control\entities\base\actions_validator.pyc 
