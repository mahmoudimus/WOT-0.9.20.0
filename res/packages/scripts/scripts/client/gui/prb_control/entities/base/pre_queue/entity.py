...
class PreQueueEntryPoint(BasePrbEntryPoint):
    ...
    def __init__(self, modeFlags, queueType):
        ...
        raise queueType in QUEUE_TYPE.ALL or queueType == QUEUE_TYPE.UNKNOWN or AssertionError
...
class PreQueueEntity(BasePreQueueEntity, ListenersCollection):
    ...
    def _validateParentControl(self):
        ...
        return result
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\prb_control\entities\base\pre_queue\entity.pyc 
