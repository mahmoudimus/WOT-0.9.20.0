# 2017.08.29 21:45:35 Støední Evropa (letní èas)
...
class FalloutSquadEntity(SquadEntity):
    ...
    def getQueueType(self):
        ...
        if rosterType == ROSTER_TYPE.FALLOUT_MULTITEAM_ROSTER:
            return QUEUE_TYPE.FALLOUT_MULTITEAM
        return super(FalloutSquadEntity, self).getQueueType()
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\prb_control\entities\fallout\squad\entity.pyc 
