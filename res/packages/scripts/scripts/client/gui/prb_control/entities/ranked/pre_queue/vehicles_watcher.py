...
class RankedVehiclesWatcher(object):
    ...
    def __onInventoryChanged(self, diff):
        ...
        """
        self.__setUnsuitableState()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\prb_control\entities\ranked\pre_queue\vehicles_watcher.pyc 
