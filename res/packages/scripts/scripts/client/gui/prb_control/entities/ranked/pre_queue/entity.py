...
class RankedEntity(PreQueueEntity):
    ...
    def doSelectAction(self, action):
        ...
        if name in (PREBATTLE_ACTION_NAME.RANKED, PREBATTLE_ACTION_NAME.RANKED_FORCED):
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\prb_control\entities\ranked\pre_queue\entity.pyc 
