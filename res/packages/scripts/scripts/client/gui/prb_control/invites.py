...
class AutoInvitesNotifier(object):
    ...
    def __pe_onPrbAutoInvitesChanged(self):
        self.__doNotify()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\prb_control\invites.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:45:20 Støední Evropa (letní èas)
