...
class PrbAutoInviteInfo(_PrbInviteInfo):
    ...
    def as_dict(self):
        ...
        return result
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\prb_control\formatters\invites.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:45:44 Støední Evropa (letní èas)
