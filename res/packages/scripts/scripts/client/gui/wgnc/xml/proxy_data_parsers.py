...
class _EncyclopediaContentParser(SectionParser):
    ...
    def getTagName(self):
        return 'encyclopedia_content_received'
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\wgnc\xml\proxy_data_parsers.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:50:29 Støední Evropa (letní èas)
