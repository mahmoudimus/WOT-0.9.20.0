# 2017.08.29 21:44:56 Støední Evropa (letní èas)
...
class DataAggregator(object):
    ...
    def __getRawElement(self, cType, nationID, itemID):
        ...
        if cType == CUSTOMIZATION_TYPE.INSCRIPTION:
            return self._vehiclesCache.customization(nationID)['inscriptions'][itemID]
    ...
    def __getGroups(self, cType, nationID):
        ...
        if cType == CUSTOMIZATION_TYPE.INSCRIPTION:
            return self._vehiclesCache.customization(nationID)['inscriptionGroups']
...
class IgrDataAggregator(DataAggregator):
    ...
    def __onIGRTypeChanged(self, roomType, xpFactor):
        self._update()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\customization\data_aggregator.pyc 
