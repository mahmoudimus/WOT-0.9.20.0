# 2017.08.29 21:44:57 Støední Evropa (letní èas)
...
def elementsDiffer(firstElement, secondElement):
    if firstElement is None and secondElement is not None:
        ...
        return True
    elif firstElement is not None and secondElement is not None and firstElement.getID() != secondElement.getID():
        return True
    else:
        return False
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\customization\shared.pyc 
