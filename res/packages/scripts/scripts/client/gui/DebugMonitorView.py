# 2017.08.29 21:44:17 Støední Evropa (letní èas)
...
class DebugMonitorView(DebugView):
    ...
    def __updateViewByContentItems(self, contentItems):
        ...
        self.update()
        return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\DebugMonitorView.pyc 
