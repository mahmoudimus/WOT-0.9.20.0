# 2017.08.29 21:49:19 Støední Evropa (letní èas)
...
class VehicleStunCumulative(_Cumulativable, VehicleStun):
    ...
    def _getKey(self):
        if self.getEventCount():
            return 'vehicleStunEventCount'
        return 'vehicleStun'
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\server_events\conditions.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:49:20 Støední Evropa (letní èas)
