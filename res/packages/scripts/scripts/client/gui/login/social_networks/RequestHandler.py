# 2017.08.29 21:45:11 Støední Evropa (letní èas)
...
class RequestHandler(BaseHTTPRequestHandler):
    ...
    def log_request(self, code = '-', size = '-'):
        pass
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\login\social_networks\RequestHandler.pyc 
