# 2017.08.29 21:44:59 Støední Evropa (letní èas)
...
class WindowsStoredDataLoader(object):
    ...
    def flush(self, mask, records):
        if Settings.g_instance is None:
            ...
            return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\doc_loaders\WindowsStoredDataLoader.pyc 
