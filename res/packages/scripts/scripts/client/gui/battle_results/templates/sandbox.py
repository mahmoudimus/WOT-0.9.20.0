...
SANDBOX_PERSONAL_STATS_BLOCK.addComponent(18, shared.TrueFlag('showNoIncomeAlert'))
SANDBOX_PERSONAL_STATS_BLOCK.addComponent(19, personal.SandboxNoIncomeAlert(field='noIncomeAlert'))
