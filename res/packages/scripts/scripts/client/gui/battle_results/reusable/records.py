# 2017.08.29 21:44:45 Støední Evropa (letní èas)
...
class ReplayRecords(ResultRecord):
    ...
    def _addRecord(self, op, name, value, diff):
        clazz = op in _SUPPORTED_OPS and _SUPPORTED_OPS[op]
        if not clazz is not None:
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\battle_results\reusable\records.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:44:46 Støední Evropa (letní èas)
