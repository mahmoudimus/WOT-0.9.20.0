# 2017.08.29 21:44:42 Støední Evropa (letní èas)
...
class TotalPersonalAchievementsBlock(shared.BiDiStatsBlock):
    ...
    def addComponent(self, index, component):
        ...
        raise isinstance(component, shared.AchievementsBlock) or AssertionError('Component must be extended class AchievementBlock')
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\battle_results\components\personal.pyc 
