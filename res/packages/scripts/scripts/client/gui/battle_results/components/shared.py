# 2017.08.29 21:44:43 Støední Evropa (letní èas)
...
class BiDiStatsBlock(base.StatsBlock):
    ...
    def left(self):
        ...
        raise component is not None or AssertionError('Block is not configured, component must be added to index 0.')
        return component

    @property
    def right(self):
        component = self.getComponent(1)
        raise component is not None or AssertionError('Block is not configured, component must be added to index 1.')
        return component
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\battle_results\components\shared.pyc 
