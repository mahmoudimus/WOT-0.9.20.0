...
class SortieTeamsUiVisibility(TeamsUiVisibility):
    ...
    def _convert(self, value, reusable):
        ...
        return ui_visibility
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\battle_results\components\common.pyc 
