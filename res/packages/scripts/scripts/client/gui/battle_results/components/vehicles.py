...
class TwoTeamsStatsBlock(shared.BiDiStatsBlock):
    ...
    def addComponent(self, index, component):
        ...
        raise isinstance(component, TeamStatsBlock) or AssertionError('Component must be extended class TeamStatsBlock')
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\battle_results\components\vehicles.pyc 
