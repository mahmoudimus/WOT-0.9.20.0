...
class TwoItemsWithSlashBlock(base.StatsBlock):
    ...
    def setRecord(self, result, reusable):
        raise len(result) == 2 or AssertionError
...
class MetersToKillometersItem(base.StatsItem):
    ...
    def _convert(self, value, reusable):
        ...
        return converted
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\battle_results\components\style.pyc 
