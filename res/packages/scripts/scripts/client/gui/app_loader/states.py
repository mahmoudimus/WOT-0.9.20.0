# 2017.08.29 21:44:20 Støední Evropa (letní èas)
...
class ReplayWaiting(WaitingState):
    ...
    def _getNextState(self, ctx):
        if ctx.guiSpaceID == _SPACE_ID.BATTLE_LOADING:
            ...
            newState = None
        return newState
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\app_loader\states.pyc 
