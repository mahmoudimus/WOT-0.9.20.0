# 2017.08.29 21:44:51 Støední Evropa (letní èas)
...
class ClanAppActionHtmlTextFormatter(object):
    ...
    def getText(self, clanName):
        ...
        if len(text):
            result.append(text)
        return ''.join(result)
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\clans\formatters.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:44:52 Støední Evropa (letní èas)
