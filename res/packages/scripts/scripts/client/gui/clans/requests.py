# 2017.08.29 21:44:53 Støední Evropa (letní èas)
...
class ClanRequester(ClientRequestsByIDProcessor):
    ...
    def _doCall(self, method, *args, **kwargs):
        ...
        def _callback(data, statusCode, responseCode):
            raise requestID in self._requests or AssertionError('There is no context has been registered for given request. Probably you call callback at the same frame as request')
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\clans\requests.pyc 
