# 2017.08.29 21:44:49 Støední Evropa (letní èas)
...
def _getWgshHost(lobbyContext = None):
    if lobbyContext is None:
        ...
        return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\clans\clan_helpers.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:44:50 Støední Evropa (letní èas)
