...
class CLAN_REQUESTED_DATA_TYPE(CONST_CONTAINER):
    ...
    CLAN_GM_FRONTS = 30
    STRONGHOLD_LEAVE = 31
    STRONGHOLD_ASSIGN = 32
    STRONGHOLD_CHANGE_OPENED = 33
    STRONGHOLD_SET_VEHICLE = 34
    STRONGHOLD_SET_PLAYER_STATE = 35
    STRONGHOLD_SEND_INVITE = 36
    STRONGHOLD_KICK = 37
    STRONGHOLD_BATTLE_QUEUE = 38
    STRONGHOLD_GIVE_LEADERSHIP = 39
    STRONGHOLD_SET_RESERVE = 40
    STRONGHOLD_UPDATE = 41
    STRONGHOLD_TAKE_LEADERSHIP = 42
    STRONGHOLD_UNASSIGN = 43
    STRONGHOLD_UNSET_RESERVE = 44
    STRONGHOLD_JOIN_BATTLE = 45
    RANKED_LEAGUE_POSITION = 46
    HOF_USER_INFO = 47
    HOF_USER_EXCLUDE = 48
    HOF_USER_RESTORE = 49
...
def _getNoClanEmblemPath(size):
    return '%s/%s%dx%d.png' % (DEFAULT_EMBLEM_PATH,
     ...
     size,
     size)
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\clans\settings.pyc 
