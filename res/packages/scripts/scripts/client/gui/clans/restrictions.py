...
class AccountClanLimits(BaseAccountClanLimits):
    ...
    def __checkPermissions(self, permName, clan = None):
        ...
        if not getattr(perms, permName)():
            return error(_CCR.DEFAULT)
        return success()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\gui\clans\restrictions.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:44:54 Støední Evropa (letní èas)
