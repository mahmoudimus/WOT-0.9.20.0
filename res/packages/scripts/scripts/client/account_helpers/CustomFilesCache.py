# 2017.08.29 21:43:15 Støední Evropa (letní èas)
...
class CustomFilesCache(object):
    ...
    def __onPostTask(self, url, invokeAndReleaseCallbacks, file):
        ...
        for cb in cbs:
            cb(url, file)
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\account_helpers\CustomFilesCache.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:43:16 Støední Evropa (letní èas)
