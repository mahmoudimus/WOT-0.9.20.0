...
class Shop(object):
    ...
    def getSellPrice(self, buyPrice, sellPriceModifiers, itemTypeID):
        ...
        if not shopRev == self.__getCacheRevision():
            ...
            crystalExchangeRate = crystalPrice and self.__cache['crystalExchangeRate']
...
def _subtractPrices(price1, price2):
    return (price1[0] - price2[0], price1[1] - price2[1])
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\account_helpers\Shop.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:43:19 Støední Evropa (letní èas)
