...
class DossierCache(object):
    ...
    def __writeCache(self):
        ...
        if fileHandler is not None:
            fileHandler.close()
        return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\account_helpers\DossierCache.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:43:17 Støední Evropa (letní èas)
