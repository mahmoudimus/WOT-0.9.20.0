# 2017.08.29 21:43:26 Støední Evropa (letní èas)
...
class VideoSettingsStorage(ISettingsStorage):
    ...
    def videoModeForAdapterOutputIndex(self, adapterOutputIndex):
        ...
        if not adapterOutputExclusiveFullscreenModes:
            ...
            adapterOutputIndex == g_monitorSettings.activeMonitor and LOG_ERROR('Unable to find appropriate display mode for the target monitor, falling back to the current mode.')
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\account_helpers\settings_core\settings_storages.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:43:27 Støední Evropa (letní èas)
