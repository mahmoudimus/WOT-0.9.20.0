...
class ServerSettingsManager(object):
    ...
    def _setSettingsSections(self, data):
        ...
        return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\account_helpers\settings_core\ServerSettingsManager.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:43:24 Støední Evropa (letní èas)
