# 2017.08.29 21:43:20 Støední Evropa (letní èas)
...
class IntUserSettings(object):
    ...
    def __onGetCacheResponse(self, callback, resultID):
        if resultID < 0:
            ...
            return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\account_helpers\settings_core\IntUserSettings.pyc 
