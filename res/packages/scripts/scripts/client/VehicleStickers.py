...
class VehicleStickers(object):
    ...
    def delDamageSticker(self, code):
        ...
        return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\VehicleStickers.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:43:11 Støední Evropa (letní èas)
