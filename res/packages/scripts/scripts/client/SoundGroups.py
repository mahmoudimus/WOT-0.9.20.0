...
class SoundGroups(object):
    ...
    def setEnableStatus(self, status):
        raise status in SOUND_ENABLE_STATUS_VALUES or AssertionError
...
def LSstartAll():
    if WWISE.enabled and ENABLE_LS:
        WWISE.LSstartAll()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\SoundGroups.pyc 
