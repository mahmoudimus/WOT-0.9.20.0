...
class PixieCache(object):
    ...
    def onPixieLoaded(pixieBG):
        ...
        if pixieInfo is not None:
            ...
            pixieBG.pixie.removeAllSystems()
        return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\helpers\PixieNode.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:50:40 Støední Evropa (letní èas)
