# 2017.08.29 21:50:38 Støední Evropa (letní èas)
...
class ShelfLocalCache(object):
    ...
    def __clearFlushCb(self):
        if self.__flushCbID is not None:
            ...
            self.__flushCbID = None
        return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\helpers\local_cache.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:50:39 Støední Evropa (letní èas)
