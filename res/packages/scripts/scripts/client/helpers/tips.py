# 2017.08.29 21:50:42 Støední Evropa (letní èas)
...
def _getRankedTipIterator():
    ...
    raise tipSize == len(TIPS.RANKED_ALL_BODY_ENUM) or AssertionError
    if not tipSize == len(TIPS.RANKED_ALL_TITLE_ENUM):
...
def _getConditionedTips(arenaGuiType, battlesCount, vehicleType, vehicleNation, vehicleLvl):
    ...
    return result
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\helpers\tips.pyc 
