# 2017.08.29 21:43:03 Støední Evropa (letní èas)
...
class OfflineMapCreator:
    ...
    def __getArenaTypeId(mapName):
        ...
        raise bool(info) or AssertionError('Unknown map: {}'.format(mapName))
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\OfflineMapCreator.pyc 
