# 2017.08.29 21:52:06 Støední Evropa (letní èas)
...
class PeripheralsController(Component):
    ...
    def update(self, vehicle, crashedTrackCtrl):
        if not crashedTrackCtrl is not None:
            ...
            self.__auxiliaryFxCtrl is not None and self.__auxiliaryFxCtrl.update(vehicle)
        return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\vehicle_systems\components\peripherals_controller.pyc 
