# 2017.08.29 21:52:07 Støední Evropa (letní èas)
...
class VibroManager:
    ...
    def update(self):
        if not self.canWork():
            ...
            return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\Vibroeffects\VibroManager.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:52:08 Støední Evropa (letní èas)
