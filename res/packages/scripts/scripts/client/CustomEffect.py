# 2017.08.29 21:42:57 Støední Evropa (letní èas)
...
class RangeSelectorDesc(SelectorDesc):
    ...
    def getActiveEffects(self, effects, args = None):
        ...
        if idx > -1 and idx < len(self._selectors):
            return self._selectors[idx].getActiveEffects(effects, args)
        else:
            return
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\CustomEffect.pyc 
