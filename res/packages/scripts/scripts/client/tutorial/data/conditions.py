# 2017.08.29 21:51:52 Støední Evropa (letní èas)
...
class Conditions(list):
    ...
    def clear(self):
        ...
        while len(self):
            self.pop()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\tutorial\data\conditions.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:51:53 Støední Evropa (letní èas)
