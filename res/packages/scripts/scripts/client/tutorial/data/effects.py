...
class SetGuiItemProperty(HasTargetEffect):
    ...
    def clear(self):
        ...
        self.__props.clear()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\tutorial\data\effects.pyc 
