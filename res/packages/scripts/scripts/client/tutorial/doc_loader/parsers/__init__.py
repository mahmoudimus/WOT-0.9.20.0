# 2017.08.29 21:51:54 Støední Evropa (letní èas)
...
class HintsParser(object):
    ...
    def parse(filePath, excludedHints):
        ...
        return hints
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\tutorial\doc_loader\parsers\__init__.pyc 
