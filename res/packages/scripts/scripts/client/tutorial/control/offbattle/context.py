# 2017.08.29 21:51:48 Støední Evropa (letní èas)
...
class OffbattleBonusesRequester(LobbyBonusesRequester):
    ...
    def getChapter(self, chapterID = None):
        if self.__chapter is not None:
            ...
            return self._data
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\tutorial\control\offbattle\context.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:51:49 Støední Evropa (letní èas)
