# 2017.08.29 21:51:42 Støední Evropa (letní èas)
...
class GoToSceneEffect(FunctionalEffect):
    ...
    def triggerEffect(self):
        ...
        if sceneID is None:
            ...
            return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\tutorial\control\functional.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:51:43 Støední Evropa (letní èas)
