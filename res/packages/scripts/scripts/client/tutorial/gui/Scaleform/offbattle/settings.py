# 2017.08.29 21:52:01 Støední Evropa (letní èas)
...
OFFBATTLE_VIEW_SETTINGS = (GroupedViewSettings(OFFBATTLE_VIEW_ALIAS.GREETING_DIALOG, TutorialGreetingDialog, 'tutorialGreetingDialog.swf', ViewTypes.TOP_WINDOW, '', None, ScopeTemplates.DEFAULT_SCOPE, isModal=True, canClose=False, canDrag=False),
 GroupedViewSettings(OFFBATTLE_VIEW_ALIAS.QUEUE_DIALOG, TutorialQueueDialog, 'tutorialQueueDialog.swf', ViewTypes.TOP_WINDOW, '', None, ScopeTemplates.DEFAULT_SCOPE, isModal=True, canClose=False),
 ...
 GroupedViewSettings(OFFBATTLE_VIEW_ALIAS.CONFIRM_REFUSE_DIALOG, off_pop_ups.TutorialConfirmRefuseDialog, 'tutorialConfirmRefuseDialog.swf', ViewTypes.TOP_WINDOW, '', None, ScopeTemplates.DEFAULT_SCOPE, isModal=True))
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\tutorial\gui\Scaleform\offbattle\settings.pyc 
