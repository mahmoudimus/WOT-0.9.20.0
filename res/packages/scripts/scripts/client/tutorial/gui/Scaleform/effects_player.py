# 2017.08.29 21:51:57 Støední Evropa (letní èas)
...
class EffectsPlayer(object):
    ...
    def isStillRunning(self, effectName, effectID = None):
        ...
        if effectName in self._effects:
            ...
            LOG_ERROR('GUI effect not found', effectName)
        return result
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\tutorial\gui\Scaleform\effects_player.pyc 
