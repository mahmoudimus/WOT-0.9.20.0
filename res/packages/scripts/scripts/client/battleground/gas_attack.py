# 2017.08.29 21:43:42 Støední Evropa (letní èas)
...
def initAttackManager(arena):
    global _g_instance
    visual = caps.checkAny(arena.bonusType, caps.GAS_ATTACK_MECHANICS) and arena.arenaType.gameplayName in ('fallout', 'fallout2', 'fallout3') and getattr(arena.arenaType, 'gasAttackVisual', None)
...
def finiAttackManager():
    ...
    _g_instance = None
    return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\battleground\gas_attack.pyc 
