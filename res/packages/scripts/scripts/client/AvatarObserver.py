# 2017.08.29 21:42:50 Støední Evropa (letní èas)
...
class AvatarObserver(CallbackDelayer):
    ...
    def onEnterWorld(self):
        ...
        def getFilterMethod(methodName):
            ...
            method is None and LOG_ERROR('AvatarObserver.onEnterWorld(): filter does not have method %s' % methodName)
            if not False:
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\AvatarObserver.pyc 
