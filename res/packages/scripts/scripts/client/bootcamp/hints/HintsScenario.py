# 2017.08.29 21:43:50 Støední Evropa (letní èas)
...
class HintSniperOnDistance(HintBase, TriggersManager.ITriggerListener):
    ...
    @property
    def voiceover(self):
        if self.__waitingForSnipeExit:
            return self.__voiceoverExit
        return self.__voiceoverEnter
    ...
    def update(self):
        if self._state == HintBase.STATE_INACTIVE:
            ...
            if self._state == HintBase.STATE_DEFAULT:
                ...
                if self.__inSniperMode and not self.__waitingForSnipeExit or not inShootingRange and not self.__waitingForSnipeExit:
                    self._state = HintBase.STATE_DEFAULT
                    self.__shootInTarget = False
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\bootcamp\hints\HintsScenario.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:43:51 Støední Evropa (letní èas)
