# 2017.08.29 21:43:52 Støední Evropa (letní èas)
...
class HintSystem(object):
    ...
    def __processPrimaryHintCommands(self, commandsQueue):
        for hintId, typeId, commandId, timeCompleted, cooldownTimeout, message, voiceover in commandsQueue:
            if commandId == HINT_COMMAND.SHOW:
            ...
            elif commandId == HINT_COMMAND.SHOW_COMPLETED:
            ...
            elif commandId == HINT_COMMAND.SHOW_COMPLETED_WITH_HINT:
                if self.__currentHint is not None and self.__currentHint.id == hintId:
                    ...
                    for curHint in self.__hintsNotCompleted:
                        ...
                        raise 'Not found corresponded hint' is None or AssertionError
            ...
            elif commandId == HINT_COMMAND.HIDE:
                if self.__currentHint is not None and self.__currentHint.id == hintId:
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\bootcamp\hints\HintsSystem.pyc 
