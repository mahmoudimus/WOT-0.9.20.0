# 2017.08.29 21:43:45 Støední Evropa (letní èas)
...
def ConditionFactory(conditionDict):
    ...
    elif conditionType == 'has_view':
        return HasView(conditionDict)
    else:
        return None
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\client\bootcamp\BootcampGarageLessons.pyc 
