# 2017.08.29 21:52:39 Støední Evropa (letní èas)
...
class _Line:
    ...
    def strarray(self):
        return ['  <line x1="%d" y1="%d" x2="%d" y2="%d" />\n' % (self.start[0],
          ...
          self.end[0],
          self.end[1])]
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\PhysicsTurretShape.pyc 
