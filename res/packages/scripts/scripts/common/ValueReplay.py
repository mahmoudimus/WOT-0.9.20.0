# 2017.08.29 21:52:47 Støední Evropa (letní èas)
...
class ValueReplayConnector(object):
    ...
    def __init__(self, battleResultsStruct, battleResults):
        raise len(battleResultsStruct) < 1024 or AssertionError
    ...
    def makeIndex(paramIndex, paramSubIndex, secondParamIndex):
        ...
        raise coder.checkFit(0, paramIndex) or AssertionError
        raise coder.checkFit(1, paramSubIndex) or AssertionError
        raise coder.checkFit(2, secondParamIndex) or AssertionError
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\ValueReplay.pyc 
