# 2017.08.29 21:52:45 Støední Evropa (letní èas)
...
class UnitBase(OpsUnpacker):
    ...
    def checkVehicleTypesRange(self, vehicleTypes):
        ...
        elif any((value > vehicleTypes[key][1] for key, value in vehicleCount.iteritems())):
    ...
    def _checkAllVehiclesMatchSlot(self, accountDBID, unitSlotIdx):
        ...
        return True
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\UnitBase.pyc 
