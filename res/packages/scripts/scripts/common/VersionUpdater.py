# 2017.08.29 21:52:48 Støední Evropa (letní èas)
...
class VersionUpdaterBase(object):
    ...
    def _updateToLatestVersion(self, versionOrGetter, logID, *args):
        ...
        return args
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\VersionUpdater.pyc 
