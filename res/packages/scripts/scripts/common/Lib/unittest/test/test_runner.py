# 2017.08.29 21:59:13 Støední Evropa (letní èas)
# Embedded file name: scripts/common/Lib/unittest/test/test_runner.py
import unittest
...
if __name__ == '__main__':
    unittest.main()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\unittest\test\test_runner.pyc 
