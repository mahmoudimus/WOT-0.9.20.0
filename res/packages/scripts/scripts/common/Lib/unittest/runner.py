# 2017.08.29 21:59:08 Støední Evropa (letní èas)
...
class TextTestRunner(object):
    ...
    def run(self, test):
        ...
        if infos:
            ...
            self.stream.write('\n')
        return result
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\unittest\runner.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:59:09 Støední Evropa (letní èas)
