# 2017.08.29 21:59:06 Støední Evropa (letní èas)
...
class FunctionTestCase(TestCase):
    ...
    def shortDescription(self):
        if self._description is not None:
            ...
            return doc and doc.split('\n')[0].strip() or None
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\unittest\case.pyc 
