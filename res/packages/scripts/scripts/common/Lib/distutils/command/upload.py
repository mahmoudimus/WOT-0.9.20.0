# 2017.08.29 21:56:10 Støední Evropa (letní èas)
# Embedded file name: scripts/common/Lib/distutils/command/upload.py
...
class upload(PyPIRCCommand):
    ...
    user_options = PyPIRCCommand.user_options + [('sign', 's', 'sign files to upload using gpg'), ('identity=', 'i', 'GPG identity used to sign files')]
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\distutils\command\upload.pyc 
