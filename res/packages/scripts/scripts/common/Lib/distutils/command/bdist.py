# 2017.08.29 21:56:03 Støední Evropa (letní èas)
...
class bdist(Command):
    ...
    user_options = [('bdist-base=', 'b', 'temporary directory for creating built distributions'),
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\distutils\command\bdist.pyc 
