...
def gen_lib_options(compiler, library_dirs, runtime_library_dirs, libraries):
    ...
    return lib_opts
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\distutils\ccompiler.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:55:55 Støední Evropa (letní èas)
