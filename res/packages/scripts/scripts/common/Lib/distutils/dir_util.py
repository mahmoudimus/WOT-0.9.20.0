...
def ensure_relative(path):
    ...
    if path[0:1] == os.sep:
        path = drive + path[1:]
    return path
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\distutils\dir_util.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:55:57 Støední Evropa (letní èas)
