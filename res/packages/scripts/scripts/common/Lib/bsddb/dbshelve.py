...
class DBShelfCursor:
    ...
    def _extract(self, rec):
        if rec is None:
            ...
            return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\bsddb\dbshelve.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:55:19 Støední Evropa (letní èas)
