# 2017.08.29 21:55:18 Støední Evropa (letní èas)
# Embedded file name: scripts/common/Lib/bsddb/dbobj.py
import sys
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\bsddb\dbobj.pyc 
