# 2017.08.29 21:55:23 Støední Evropa (letní èas)
...
class DB_general(DB):
    ...
    def test_get_open_flags2(self):
        self.db.open(self.path, dbtype=db.DB_HASH, flags=db.DB_CREATE | db.DB_THREAD)
    ...
    def test_get_dbname_filename_database(self):
        ...
        self.db.open(self.path, dbname=name, dbtype=db.DB_HASH, flags=db.DB_CREATE)
...
class DB_hash(DB):
    ...
    def test_pagesize(self):
        ...
        self.assertRaises(db.DBInvalidArgError, self.db.set_pagesize, 131072)
        self.assertRaises(db.DBInvalidArgError, self.db.set_pagesize, 256)
...
class DB_txn(DB):
    ...
    def test_get_transactional(self):
        self.assertFalse(self.db.get_transactional())
        self.db.open('XXX', dbtype=db.DB_HASH, flags=db.DB_CREATE | db.DB_AUTO_COMMIT)
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\bsddb\test\test_db.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:55:24 Støední Evropa (letní èas)
