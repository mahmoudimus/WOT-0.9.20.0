    ...
    def test04_lock_timeout2(self):
        ...
        def deadlock_detection():
            while not deadlock_detection.end:
                deadlock_detection.count = self.env.lock_detect(db.DB_LOCK_EXPIRE)
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\bsddb\test\test_lock.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:55:27 Støední Evropa (letní èas)
