...
musicdata = {1: ('Bad English', 'The Price Of Love', 'Rock'),
...
class AssociateTestCase(unittest.TestCase):
    ...
    if db.version() >= (4, 6):
        ...
        def test03_associateWithDB(self):
            if verbose:
                print '\n', '-=' * 30
                print 'Running %s.test03_associateWithDB...' % self.__class__.__name__
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\bsddb\test\test_associate.pyc 
