...
# Embedded file name: scripts/common/Lib/bsddb/test/test_dbenv.py
import unittest
import os, glob
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\bsddb\test\test_dbenv.pyc 
