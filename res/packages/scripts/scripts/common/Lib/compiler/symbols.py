# 2017.08.29 21:55:33 Støední Evropa (letní èas)
...
class Scope:
    ...
    def check_name(self, name):
        ...
        if name in self.globals:
            ...
            return SC_LOCAL
        elif self.nested and (name in self.frees or name in self.uses):
            return SC_FREE
        elif self.nested:
            return SC_UNKNOWN
        else:
        ...
        for s in syms.get_symbols():
            if s.is_namespace():
                ...
                if len(l) > 1:
                    ...
                    sys.exit(-1)
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\compiler\symbols.pyc 
