...
class Class(Node):
    ...
    def __repr__(self):
        return 'Class(%s, %s, %s, %s, %s)' % (repr(self.name),
         repr(self.bases),
         repr(self.doc),
         repr(self.code),
         repr(self.decorators))
...
class For(Node):
    ...
    def __repr__(self):
        return 'For(%s, %s, %s, %s)' % (repr(self.assign),
         repr(self.list),
         repr(self.body),
         repr(self.else_))
...
class Function(Node):
    ...
    def __repr__(self):
        return 'Function(%s, %s, %s, %s, %s, %s, %s)' % (repr(self.decorators),
         repr(self.name),
         repr(self.argnames),
         repr(self.defaults),
         repr(self.flags),
...
class Slice(Node):
    ...
    def __repr__(self):
        return 'Slice(%s, %s, %s, %s)' % (repr(self.expr),
         repr(self.flags),
         repr(self.lower),
         repr(self.upper))
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\compiler\ast.pyc 
