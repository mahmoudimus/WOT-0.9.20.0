# 2017.08.29 21:58:20 Støední Evropa (letní èas)
# Embedded file name: scripts/common/Lib/plat-irix5/torgb.py
...
def _torgb(filename, temps):
    ...
    if ftype == 'rgb':
        ...
        return temp
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\plat-irix5\torgb.pyc 
