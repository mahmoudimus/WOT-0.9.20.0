# 2017.08.29 21:58:19 Støední Evropa (letní èas)
...
def parse_file(fp):
    ...
    return exprlist
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\plat-irix5\panelparser.pyc 
