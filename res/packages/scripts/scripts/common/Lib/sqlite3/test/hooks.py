...
if __name__ == '__main__':
    test()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\sqlite3\test\hooks.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:59:05 Støední Evropa (letní èas)
