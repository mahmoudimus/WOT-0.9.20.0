# 2017.08.29 21:54:37 Støední Evropa (letní èas)
...
class FileBase():
    ok_file_methods = ('fileno', 'flush', 'isatty', 'read', 'readline', 'readlines', 'seek', 'tell', 'write', 'writelines', 'xreadlines', '__iter__')
...
if __name__ == '__main__':
    sys.exit(test())
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\rexec.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:54:38 Støední Evropa (letní èas)
