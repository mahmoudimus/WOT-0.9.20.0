...
# Embedded file name: scripts/common/Lib/plat-freebsd5/IN.py
IPPROTO_IP = 0
IPPROTO_HOPOPTS = 0
IPPROTO_ICMP = 1
IPPROTO_IGMP = 2
...
def IN_CLASSA(i):
    return u_int32_t(i) & 2147483648L == 0
...
def IN_CLASSB(i):
    return u_int32_t(i) & 3221225472L == 2147483648L
...
def IN_CLASSC(i):
    return u_int32_t(i) & 3758096384L == 3221225472L
...
def IN_CLASSD(i):
    return u_int32_t(i) & 4026531840L == 3758096384L
...
def IN_EXPERIMENTAL(i):
    return u_int32_t(i) & 4026531840L == 4026531840L
...
def SLIST_HEAD_INITIALIZER(head):
    pass


def SLIST_ENTRY(type):
    pass


def STAILQ_HEAD_INITIALIZER(head):
    pass


def STAILQ_ENTRY(type):
    pass


def LIST_HEAD_INITIALIZER(head):
    pass
...
IPV6_ADDR_INT32_MNL = 4278255616L
IPV6_ADDR_INT32_MLL = 4278321152L
...
IPV6_ADDR_INT32_SMP = 4294901760L
...
IPV6CTL_MAXID = 28
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\plat-freebsd5\IN.pyc 
