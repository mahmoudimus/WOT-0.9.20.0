# 2017.08.29 21:54:39 Støední Evropa (letní èas)
...
def _get_main_module_details():
    ...
    try:
        ...
        if main_name in str(exc):
            raise ImportError("can't find %r module in %r" % (main_name, sys.path[0]))
        raise
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\runpy.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:54:40 Støední Evropa (letní èas)
