...
class StructureTestCase(unittest.TestCase):
    ...
    def test_ccharp_struct(self):
        ...
        x.a = 'spam'
        x.b = 'foo'
        self.assertEqual(x._objects, {'0': 'spam',
         '1': 'foo'})
        return
...
if __name__ == '__main__':
    unittest.main()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\ctypes\test\test_keeprefs.pyc 
