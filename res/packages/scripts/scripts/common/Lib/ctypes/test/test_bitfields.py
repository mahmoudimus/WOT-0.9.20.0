# 2017.08.29 21:55:42 Støední Evropa (letní èas)
# Embedded file name: scripts/common/Lib/ctypes/test/test_bitfields.py
from ctypes import *
import unittest
import os
import ctypes
...
signed_int_types = (c_byte,
 c_short,
 c_int,
 c_long,
 c_longlong)
unsigned_int_types = (c_ubyte,
 c_ushort,
 c_uint,
 c_ulong,
 c_ulonglong)
...
class BitFieldTest(unittest.TestCase):
    ...
    def test_uint32(self):
        ...
        x.a = 4257982855L
        self.assertEqual(x.a, 4257982855L)
    ...
    def test_uint64(self):
        ...
        x.a = 10
        self.assertEqual(x.a, 10)
        x.a = 18364758544493064721L
        self.assertEqual(x.a, 18364758544493064721L)


if __name__ == '__main__':
    unittest.main()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\ctypes\test\test_bitfields.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:55:43 Støední Evropa (letní èas)
