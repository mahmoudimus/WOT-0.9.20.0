# 2017.08.29 21:55:50 Støední Evropa (letní èas)
...
class StructureTestCase(unittest.TestCase):
    ...
    def test_intarray_fields(self):
        ...
        self.assertEqual(SomeInts((1, 2)).a[:], [1,
         2,
         0,
         0])
        self.assertEqual(SomeInts((1, 2)).a[::], [1,
         ...
         0,
         0])
        self.assertEqual(SomeInts((1, 2)).a[::-1], [0,
         0,
         2,
         1])
        ...
        self.assertEqual(SomeInts((1, 2, 3, 4)).a[:], [1,
         2,
         3,
         4])
        self.assertEqual(SomeInts((1, 2, 3, 4)).a[::], [1,
...
if __name__ == '__main__':
    unittest.main()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\ctypes\test\test_structures.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:55:51 Støední Evropa (letní èas)
