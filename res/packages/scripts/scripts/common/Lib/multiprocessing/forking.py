# 2017.08.29 21:58:07 Støední Evropa (letní èas)
...
def prepare(data):
    ...
    return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\multiprocessing\forking.pyc 
