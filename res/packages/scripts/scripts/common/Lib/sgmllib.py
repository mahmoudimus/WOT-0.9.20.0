...
# Embedded file name: scripts/common/Lib/sgmllib.py
...
if __name__ == '__main__':
    test()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\sgmllib.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:54:41 Støední Evropa (letní èas)
