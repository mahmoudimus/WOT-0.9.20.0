# 2017.08.29 21:58:14 Støední Evropa (letní èas)
...
def minor(dev):
    return dev & 255
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\plat-atheos\TYPES.pyc 
