# 2017.08.29 21:56:21 Støední Evropa (letní èas)
        ...
        if charset != '8bit':
            if isinstance(s, str):
                ...
                for charset in (USASCII, charset, UTF8):
                    ...
                    raise False or AssertionError('utf-8 conversion failed')
...
def _binsplit(splittable, charset, maxlinelen):
    ...
    return (first, last)
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\email\header.pyc 
