...
class TestMIMEApplication(unittest.TestCase):
    ...
    def test_binary_body_with_encode_7or8bit(self):
        bytesdata = '\xfa\xfb\xfc\xfd\xfe\xff'
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\email\test\test_email_renamed.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:56:29 Støední Evropa (letní èas)
