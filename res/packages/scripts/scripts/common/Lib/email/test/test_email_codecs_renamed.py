...
# Embedded file name: scripts/common/Lib/email/test/test_email_codecs_renamed.py
import unittest
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\email\test\test_email_codecs_renamed.pyc 
