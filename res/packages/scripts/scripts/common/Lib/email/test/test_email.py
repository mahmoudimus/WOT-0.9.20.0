# 2017.08.29 21:56:25 Støední Evropa (letní èas)
...
class TestMessageAPI(TestEmailBase):
    ...
    def test_get_decoded_payload(self):
        ...
        eq(msg.get_payload(1).get_payload(decode=True), '\xa1This is a Quoted Printable encoded message!\n')
...
class TestLongHeaders(TestEmailBase):
    ...
    def test_long_8bit_header_no_charset(self):
        ...
        eq(msg.as_string(), 'Reply-To: Britische Regierung gibt gr\xfcnes Licht f\xfcr Offshore-Windkraftprojekte <a-very-long-address@example.com>\n\n')
    ...
    def test_string_headerinst_eq(self):
        ...
        msg = Message()
        msg['Received'] = Header(h, header_name='Received', continuation_ws='\t')
        msg['Received'] = h
...
class TestRFC2047(unittest.TestCase):
    ...
    def test_whitespace_eater_unicode_2(self):
        ...
        dh = decode_header(s)
        eq(dh, [('The', None),
         ('quick brown fox', 'iso-8859-1'),
         ('jumped over the', None),
         ('lazy dog', 'iso-8859-1')])
...
class TestHeader(TestEmailBase):
    ...
    def test_nonascii_add_header_via_triple(self):
        msg = Message()
        msg.add_header('Content-Disposition', 'attachment', filename=('iso-8859-1', '', 'Fu\xdfballer.ppt'))
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\email\test\test_email.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:56:27 Støední Evropa (letní èas)
