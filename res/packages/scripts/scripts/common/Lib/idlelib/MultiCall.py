...
def MultiCallCreator(widget):
    ...
    class MultiCall(widget):
        raise issubclass(widget, Tkinter.Misc) or AssertionError
...
if __name__ == '__main__':
    ...
    bindseq('<Leave>')
    root.mainloop()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\idlelib\MultiCall.pyc 
