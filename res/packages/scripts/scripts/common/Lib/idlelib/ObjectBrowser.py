# 2017.08.29 21:57:00 Støední Evropa (letní èas)
...
class InstanceTreeItem(ObjectTreeItem):
    ...
    def GetSubList(self):
        ...
        sublist.insert(0, make_objecttreeitem('__class__ =', self.object.__class__))
        return sublist
...
from types import *
dispatch = {IntType: AtomicObjectTreeItem,
...
if __name__ == '__main__':
    _test()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\idlelib\ObjectBrowser.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:57:01 Støední Evropa (letní èas)
