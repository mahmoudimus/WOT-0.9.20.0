# 2017.08.29 21:57:02 Støední Evropa (letní èas)
...
class ModifiedColorDelegator(ColorDelegator):
    ...
    def LoadTagDefs(self):
        ...
        self.tagdefs.update({'stdin': {'background': None,
                   'foreground': None},
...
class ModifiedInterpreter(InteractiveInterpreter):
    ...
    def stuffsource(self, source):
        ...
        self.gid = self.gid + 1
        lines = source.split('\n')
        linecache.cache[filename] = (len(source) + 1,
         0,
         lines,
         filename)
        return filename
...
if __name__ == '__main__':
    ...
    main()
capture_warnings(False)
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\idlelib\PyShell.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:57:04 Støední Evropa (letní èas)
