...
# Embedded file name: scripts/common/Lib/idlelib/idle_test/test_text.py
import unittest
...
class TextTest(object):
    ...
    def test_index_empty(self):
        ...
        for dex in (-1.0, 0.3, '1.-1', '1.0', '1.0 lineend', '1.end', '1.33', 'insert'):
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\idlelib\idle_test\test_text.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:57:13 Støední Evropa (letní èas)
