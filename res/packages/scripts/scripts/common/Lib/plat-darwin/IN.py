...
def IN_LINKLOCAL(i):
    return u_int32_t(i) & IN_CLASSB_NET == IN_LINKLOCALNETNUM
...
IPV6CTL_MAXID = 37
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\plat-darwin\IN.pyc 
