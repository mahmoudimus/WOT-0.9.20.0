# 2017.08.29 21:57:46 Støední Evropa (letní èas)
...
class ParserGenerator(object):
        ...
        for label, itsfirst in overlapcheck.iteritems():
            for symbol in itsfirst:
                if symbol in inverse:
                    raise ValueError('rule %s is ambiguous; %s is in the first sets of %s as well as %s' % (name,
                     symbol,
                     label,
                     inverse[symbol]))
    ...
    def raise_error(self, msg, *args):
        ...
        raise SyntaxError(msg, (self.filename,
         self.end[0],
         self.end[1],
         self.line))
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\lib2to3\pgen2\pgen.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:57:47 Støední Evropa (letní èas)
