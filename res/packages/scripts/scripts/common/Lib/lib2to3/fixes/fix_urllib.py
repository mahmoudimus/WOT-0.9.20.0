# 2017.08.29 21:57:44 Støední Evropa (letní èas)
...
MAPPING = {'urllib': [('urllib.request', ['URLopener',
              'FancyURLopener',
              'urlretrieve',
              '_urlopener',
              'urlopen',
              'urlcleanup',
              'pathname2url',
              'url2pathname']), ('urllib.parse', ['quote',
              'quote_plus',
              'unquote',
              'unquote_plus',
              'urlencode',
              ...
              'splittype',
              'splituser',
              'splitvalue']), ('urllib.error', ['ContentTooShortError'])],
 'urllib2': [('urllib.request', ['urlopen',
               ...
               'FTPHandler',
               'CacheFTPHandler',
               'UnknownHandler']), ('urllib.error', ['URLError', 'HTTPError'])]}
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\lib2to3\fixes\fix_urllib.pyc 
