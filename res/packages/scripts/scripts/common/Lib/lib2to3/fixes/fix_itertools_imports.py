# 2017.08.29 21:57:41 Støední Evropa (letní èas)
...
class FixItertoolsImports(fixer_base.BaseFix):
    ...
    def transform(self, node, results):
        ...
        if not (imports.children or getattr(imports, 'value', None)) or imports.parent is None:
            ...
            return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\lib2to3\fixes\fix_itertools_imports.pyc 
