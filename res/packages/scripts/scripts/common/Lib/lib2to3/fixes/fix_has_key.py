...
class FixHasKey(fixer_base.BaseFix):
    ...
    def transform(self, node, results):
        if not results:
            ...
            new.prefix = prefix
            return new
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\lib2to3\fixes\fix_has_key.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:57:40 Støední Evropa (letní èas)
