# 2017.08.29 21:57:42 Støední Evropa (letní èas)
...
class FixOperator(fixer_base.BaseFix):
    ...
    def _check_method(self, node, results):
        ...
        return None
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\lib2to3\fixes\fix_operator.pyc 
