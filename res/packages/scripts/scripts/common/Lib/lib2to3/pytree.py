# 2017.08.29 21:57:36 Støední Evropa (letní èas)
        ...
        for c0, r0 in p.generate_matches(nodes):
            if not rest:
                ...
                for c1, r1 in generate_matches(rest, nodes[c0:]):
                    ...
                    r.update(r1)
                    yield (c0 + c1, r)
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\lib2to3\pytree.pyc 
