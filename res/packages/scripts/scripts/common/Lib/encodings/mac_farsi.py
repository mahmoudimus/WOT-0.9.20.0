...
# Embedded file name: scripts/common/Lib/encodings/mac_farsi.py
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\encodings\mac_farsi.pyc 
