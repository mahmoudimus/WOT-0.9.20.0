...
# Embedded file name: scripts/common/Lib/encodings/koi8_r.py
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\encodings\koi8_r.pyc 
