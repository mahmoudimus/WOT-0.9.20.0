...
# Embedded file name: scripts/common/Lib/encodings/cp875.py
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\encodings\cp875.pyc 
