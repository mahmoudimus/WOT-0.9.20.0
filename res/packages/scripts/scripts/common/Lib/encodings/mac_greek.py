...
# Embedded file name: scripts/common/Lib/encodings/mac_greek.py
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\encodings\mac_greek.pyc 
