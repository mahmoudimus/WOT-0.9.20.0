# 2017.08.29 21:55:12 Støední Evropa (letní èas)
...
def _EndRecData(fpin):
    ...
    data = fpin.read()
    if len(data) == sizeEndCentDir and data[0:4] == stringEndArchive and data[-2:] == '\x00\x00':
...
if __name__ == '__main__':
    main()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\zipfile.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:55:13 Støední Evropa (letní èas)
