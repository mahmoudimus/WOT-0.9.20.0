...
# Embedded file name: scripts/common/Lib/plat-irix6/AL.py
...
ENUM_VALUE = 0
RANGE_VALUE = 1
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\plat-irix6\AL.pyc 
