...
# Embedded file name: scripts/common/Lib/plat-irix6/SV.py
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\plat-irix6\SV.pyc 
