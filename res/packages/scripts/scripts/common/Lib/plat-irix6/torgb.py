...
# Embedded file name: scripts/common/Lib/plat-irix6/torgb.py
...
def _torgb(filename, temps):
    ...
    if ftype == 'rgb':
        ...
        return temp
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\plat-irix6\torgb.pyc 
