...
# Embedded file name: scripts/common/Lib/plat-irix6/FL.py
...
TIMER_BLINKRATE = 0.2
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\plat-irix6\FL.pyc 
