# 2017.08.29 21:58:23 Støední Evropa (letní èas)
# Embedded file name: scripts/common/Lib/plat-irix6/panelparser.py
...
def parse_file(fp):
    ...
    return exprlist
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\plat-irix6\panelparser.pyc 
