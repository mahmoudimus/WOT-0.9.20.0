# 2017.08.29 21:57:24 Støední Evropa (letní èas)
...
class Style(object):
    ...
    def map(self, style, query_opt = None, **kw):
        ...
        if query_opt is not None:
            return _list_from_statespec(self.tk.splitlist(self.tk.call(self._name, 'map', style, '-%s' % query_opt)))
        else:
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\lib-tk\ttk.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:57:26 Støední Evropa (letní èas)
