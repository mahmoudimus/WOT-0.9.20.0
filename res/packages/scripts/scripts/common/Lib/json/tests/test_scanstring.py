# 2017.08.29 21:57:16 Støední Evropa (letní èas)
...
class TestScanstring(object):
    ...
    def test_surrogates(self):
        ...
        def assertScan(given, expect):
            self.assertEqual(scanstring(given, 1, None, True), (expect, len(given)))
    ...
    def test_issue3623(self):
        ...
        self.assertRaises(UnicodeDecodeError, self.json.encoder.encode_basestring_ascii, 'xx\xff')
...
class TestCScanstring(TestScanstring, CTest):
    pass
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\json\tests\test_scanstring.pyc 
