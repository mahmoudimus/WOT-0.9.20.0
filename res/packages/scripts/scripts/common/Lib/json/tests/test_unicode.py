# 2017.08.29 21:57:17 Støední Evropa (letní èas)
# Embedded file name: scripts/common/Lib/json/tests/test_unicode.py
...
class TestUnicode(object):
    ...
    def test_default_encoding(self):
        self.assertEqual(self.loads(u'{"a": "\xe9"}'.encode('utf-8')), {'a': u'\xe9'})
...
class TestCUnicode(TestUnicode, CTest):
    pass
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\json\tests\test_unicode.pyc 
