# 2017.08.29 21:59:00 Støední Evropa (letní èas)
...
if __name__ == '__main__':
    test()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\plat-riscos\rourl2path.pyc 
