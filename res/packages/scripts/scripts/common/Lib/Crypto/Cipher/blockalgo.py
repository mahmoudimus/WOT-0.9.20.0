# 2017.08.29 21:55:36 Støední Evropa (letní èas)
...
class BlockAlgo:
    ...
    def decrypt_and_verify(self, ciphertext, mac_tag):
        ...
        self.verify(mac_tag)
        return pt
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\Crypto\Cipher\blockalgo.pyc 
