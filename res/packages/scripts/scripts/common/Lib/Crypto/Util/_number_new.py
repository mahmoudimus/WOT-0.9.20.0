# 2017.08.29 21:55:39 Støední Evropa (letní èas)
...
def exact_div(p, d, allow_divzero = False):
    ...
    return n
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\Crypto\Util\_number_new.pyc 
