# 2017.08.29 21:55:10 Støední Evropa (letní èas)
...
class XMLParser():
    ...
    __xml_namespace_attributes = {'ns': None,
     'src': None,
     'prefix': None}
...
if __name__ == '__main__':
    test()
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\xmllib.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:55:11 Støední Evropa (letní èas)
