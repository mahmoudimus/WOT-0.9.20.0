# 2017.08.29 21:59:19 Støední Evropa (letní èas)
...
class DOMBuilder:
    ...
    def setFeature(self, name, state):
        if self.supportsFeature(name):
            ...
            try:
                ...
                raise xml.dom.NotSupportedErr('unsupported feature: %r' % (name,))
            else:
    ...
    _settings = {('namespace_declarations', 0): [('namespace_declarations', 0)],
     ...
     ('infoset', 0): [],
     ('infoset', 1): [('namespace_declarations', 0),
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\xml\dom\xmlbuilder.pyc 
