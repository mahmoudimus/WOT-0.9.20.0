...
# Embedded file name: scripts/common/Lib/plat-freebsd8/IN.py
__GNUCLIKE_ASM = 3
__GNUCLIKE_ASM = 2
...
def IN_LINKLOCAL(i):
    return u_int32_t(i) & -65536 == -1442971648


def IN_LOCAL_GROUP(i):
    return u_int32_t(i) & -256 == -536870912
...
IPV6CTL_STEALTH = 45
IPV6CTL_MAXID = 46
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\plat-freebsd8\IN.pyc 
