...
# Embedded file name: scripts/common/Lib/plat-mac/Carbon/CarbonEvents.py
...
kHICommandFromMenu = 1L
kHICommandFromControl = 2L
kHICommandFromWindow = 4L
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\plat-mac\Carbon\CarbonEvents.pyc 
