...
# Embedded file name: scripts/common/Lib/plat-mac/Carbon/Icons.py
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\plat-mac\Carbon\Icons.pyc 
