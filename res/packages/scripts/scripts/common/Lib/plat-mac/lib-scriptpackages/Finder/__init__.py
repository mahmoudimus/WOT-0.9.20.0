# 2017.08.29 21:58:51 Støední Evropa (letní èas)
# Embedded file name: scripts/common/Lib/plat-mac/lib-scriptpackages/Finder/__init__.py
"""
...
import Enumerations
_code_to_module = {'CoRe': Standard_Suite,
 'fleg': Legacy_suite,
...
_classdeclarations = {'shor': StdSuites.Type_Names_Suite.small_integer,
...
class Finder(Standard_Suite_Events, Legacy_suite_Events, Containers_and_folders_Events, Files_Events, Finder_Basics_Events, Finder_items_Events, Window_classes_Events, Type_Definitions_Events, Enumerations_Events, aetools.TalkTo):
    _signature = 'MACS'
    _moduleName = 'Finder'
    _elemdict = application._elemdict
    _propdict = application._propdict
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\plat-mac\lib-scriptpackages\Finder\__init__.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:58:52 Støední Evropa (letní èas)
