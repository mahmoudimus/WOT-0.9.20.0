...
_enumdeclarations = {'arro': _Enum_arro,
 'tran': _Enum_tran}
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\plat-mac\lib-scriptpackages\StdSuites\QuickDraw_Graphics_Suite.pyc 
