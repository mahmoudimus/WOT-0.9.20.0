...
class Explorer(Standard_Suite_Events, URL_Suite_Events, Netscape_Suite_Events, Microsoft_Internet_Explorer_Events, Web_Browser_Suite_Events, Required_Suite_Events, aetools.TalkTo):
    _signature = 'MSIE'
    _moduleName = 'Explorer'
    _elemdict = application._elemdict
    _propdict = application._propdict
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\plat-mac\lib-scriptpackages\Explorer\__init__.pyc 
