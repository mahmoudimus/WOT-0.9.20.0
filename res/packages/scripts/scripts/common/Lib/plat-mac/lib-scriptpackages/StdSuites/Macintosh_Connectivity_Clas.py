...
_enumdeclarations = {'econ': _Enum_econ,
 'edvt': _Enum_edvt,
 'epro': _Enum_epro}
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\plat-mac\lib-scriptpackages\StdSuites\Macintosh_Connectivity_Clas.pyc 
