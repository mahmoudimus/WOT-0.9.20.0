# 2017.08.29 21:58:56 Støední Evropa (letní èas)
...
_code_to_module = {'TEXT': Text_Suite,
...
_code_to_fullname = {'TEXT': ('StdSuites.Text_Suite', 'Text_Suite'),
...
_classdeclarations = {'cpic': graphic_group,
 'covl': oval,
 'cgtx': graphic_text,
 'cgsh': graphic_shape,
 'cdrw': drawing_area,
...
class StdSuites(Text_Suite_Events, AppleScript_Suite_Events, Standard_Suite_Events, Macintosh_Connectivity_Clas_Events, QuickDraw_Graphics_Suite_Events, QuickDraw_Graphics_Suppleme_Events, Required_Suite_Events, Table_Suite_Events, Type_Names_Suite_Events, aetools.TalkTo):
    _signature = 'ascr'
    _moduleName = 'StdSuites'
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\plat-mac\lib-scriptpackages\StdSuites\__init__.pyc 
