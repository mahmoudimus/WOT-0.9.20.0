# 2017.08.29 21:58:50 Støední Evropa (letní èas)
...
_Enum_ecvw = {'icon_view': 'icnv',
 'list_view': 'lsvw',
 'column_view': 'clvw'}
_Enum_edfm = {'Mac_OS_format': 'dfhf',
...
_Enum_elsv = {'name_column': 'elsn',
 ...
 'version_column': 'elsv',
 'comment_column': 'elsC'}
_Enum_ipnl = {'General_Information_panel': 'gpnl',
 'Sharing_panel': 'spnl',
 'Memory_panel': 'mpnl',
 'Preview_panel': 'vpnl',
...
_Enum_isiz = {'mini': 'miic',
 'small': 'smic',
 'large': 'lgic'}
_Enum_lvic = {'small_icon': 'smic',
 'large_icon': 'lgic'}
_Enum_priv = {'read_only': 'read',
 'read_write': 'rdwr',
 'write_only': 'writ',
 'none': 'none'}
_Enum_sodr = {'normal': 'snrm',
 'reversed': 'srvs'}
_Enum_vwby = {'conflicts': 'cflc',
 'existing_items': 'exsi',
 'small_icon': 'smic',
 'icon': 'iimg',
 'name': 'pnam',
...
_propdeclarations = {}
_compdeclarations = {}
_enumdeclarations = {'earr': _Enum_earr,
 'ecvw': _Enum_ecvw,
 'edfm': _Enum_edfm,
 'elsv': _Enum_elsv,
 'ipnl': _Enum_ipnl,
 ...
 'sodr': _Enum_sodr,
 'vwby': _Enum_vwby}
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\plat-mac\lib-scriptpackages\Finder\Enumerations.pyc 
