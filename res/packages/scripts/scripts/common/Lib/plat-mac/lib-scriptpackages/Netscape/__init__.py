...
# Embedded file name: scripts/common/Lib/plat-mac/lib-scriptpackages/Netscape/__init__.py
"""
...
class Netscape(Standard_Suite_Events, Standard_URL_suite_Events, Mozilla_suite_Events, Text_Events, WorldWideWeb_suite_Events, PowerPlant_Events, Required_suite_Events, aetools.TalkTo):
    _signature = 'MOSS'
    _moduleName = 'Netscape'
    _elemdict = application._elemdict
    _propdict = application._propdict
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\plat-mac\lib-scriptpackages\Netscape\__init__.pyc 
