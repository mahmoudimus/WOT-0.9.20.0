# 2017.08.29 21:58:58 Støední Evropa (letní èas)
# Embedded file name: scripts/common/Lib/plat-mac/lib-scriptpackages/SystemEvents/__init__.py
"""
...
_code_to_fullname = {'????': ('SystemEvents.Standard_Suite', 'Standard_Suite'),
...
class SystemEvents(Standard_Suite_Events, Text_Suite_Events, Disk_Folder_File_Suite_Events, Folder_Actions_Suite_Events, Login_Items_Suite_Events, Power_Suite_Events, Processes_Suite_Events, System_Events_Suite_Events, aetools.TalkTo):
    _signature = 'sevs'
    _moduleName = 'SystemEvents'
    _elemdict = application._elemdict
    _propdict = application._propdict
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\plat-mac\lib-scriptpackages\SystemEvents\__init__.pyc 
