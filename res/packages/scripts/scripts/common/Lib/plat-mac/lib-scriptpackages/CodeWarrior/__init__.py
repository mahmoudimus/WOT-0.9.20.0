# 2017.08.29 21:58:49 Støední Evropa (letní èas)
...
import Required
_code_to_module = {'CWIE': CodeWarrior_suite,
 'CoRe': Standard_Suite,
 'MMPR': Metrowerks_Shell_Suite,
 'reqd': Required}
_code_to_fullname = {'CWIE': ('CodeWarrior.CodeWarrior_suite', 'CodeWarrior_suite'),
...
_classdeclarations = {'cha ': character,
...
class CodeWarrior(CodeWarrior_suite_Events, Standard_Suite_Events, Metrowerks_Shell_Suite_Events, Required_Events, aetools.TalkTo):
    _signature = 'CWIE'
    _moduleName = 'CodeWarrior'
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\plat-mac\lib-scriptpackages\CodeWarrior\__init__.pyc 
