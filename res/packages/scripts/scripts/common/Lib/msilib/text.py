...
ActionText = [(u'InstallValidate', u'Validating install', None),
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\msilib\text.pyc 
