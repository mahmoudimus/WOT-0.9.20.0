...
AdminUISequence = [(u'FileCost', None, 900),
 (u'CostInitialize', None, 800),
 (u'CostFinalize', None, 1000),
 ...
 (u'FatalError', None, -3),
 (u'UserExit', None, -2)]
AdvtExecuteSequence = [(u'InstallInitialize', None, 1500),
 (u'InstallFinalize', None, 6600),
 (u'CostInitialize', None, 800),
 (u'CostFinalize', None, 1000),
 (u'InstallValidate', None, 1400),
...
InstallExecuteSequence = [(u'InstallInitialize', None, 1500),
 (u'InstallFinalize', None, 6600),
 (u'InstallFiles', None, 4000),
 (u'FileCost', None, 900),
 (u'CostInitialize', None, 800),
...
InstallUISequence = [(u'FileCost', None, 900),
 (u'CostInitialize', None, 800),
 (u'CostFinalize', None, 1000),
 (u'ExecuteAction', None, 1300),
 (u'ExitDialog', None, -1),
...
tables = ['AdminExecuteSequence',
 ...
 'InstallUISequence']
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\msilib\sequence.pyc 
