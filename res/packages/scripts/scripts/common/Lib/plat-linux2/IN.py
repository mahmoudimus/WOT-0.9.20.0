...
def IN_CLASSB(a):
    return in_addr_t(a) & -1073741824 == -0x80000000
...
def IN_CLASSC(a):
    return in_addr_t(a) & -536870912 == -1073741824
...
def IN_CLASSD(a):
    return in_addr_t(a) & -268435456 == -536870912
...
def IN_EXPERIMENTAL(a):
    return in_addr_t(a) & -536870912 == -536870912


def IN_BADCLASS(a):
    return in_addr_t(a) & -268435456 == -268435456
...
def IN6_IS_ADDR_MC_GLOBAL(a):
    pass
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\Lib\plat-linux2\IN.pyc 
