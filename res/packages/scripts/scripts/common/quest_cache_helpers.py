# 2017.08.29 21:52:41 Støední Evropa (letní èas)
...
def readQuestsFromFile(filePath, eventType):
    ...
    if nodes is None:
        ...
        return
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\quest_cache_helpers.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:52:42 Støední Evropa (letní èas)
