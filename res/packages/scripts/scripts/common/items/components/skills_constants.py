# 2017.08.29 21:53:26 Støední Evropa (letní èas)
...
SKILLS_BY_ROLES = {'commander': COMMON_SKILLS.union(('commander_tutor', 'commander_expert', 'commander_universalist', 'commander_sixthSense', 'commander_eagleEye')),
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\items\components\skills_constants.pyc 
