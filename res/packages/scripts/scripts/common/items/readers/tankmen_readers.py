...
def readNationConfig(xmlPath):
    ...
    return config
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\items\readers\tankmen_readers.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:53:29 Støední Evropa (letní èas)
