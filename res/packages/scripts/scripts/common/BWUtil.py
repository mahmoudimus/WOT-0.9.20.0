# 2017.08.29 21:52:27 Støední Evropa (letní èas)
...
def async(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        raise isinstance(gen, GeneratorType) or AssertionError
        promise = BigWorld.Promise()

        def stepGen(result):
            raise isinstance(result, BigWorld.Future) or AssertionError
    ...
    return wrapper
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\BWUtil.pyc 
