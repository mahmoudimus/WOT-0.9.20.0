# 2017.08.29 21:52:52 Støední Evropa (letní èas)
...
def _updateAimer(dossierDescr, dossierBlockDescr, key, value, prevValue, block = 'singleAchievements'):
    raise value > prevValue or AssertionError('Try to store wrong value as max record')
...
# okay decompyling c:\Users\PC\wotmods\files\originals\res\packages\scripts\scripts\common\dossiers2\custom\dependencies.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.08.29 21:52:53 Støední Evropa (letní èas)
